...
extern inline int __aio_create_helper_thread(pthread_t *threadp, void *(*tf)(void *), void *arg)
{
    pthread_attr_t attr;
...
static struct requestlist *get_elem(void)
{
...
void __aio_free_request(struct requestlist *elem)
{
    elem->running = no;
...
void __aio_remove_request(struct requestlist *last, struct requestlist *req,
                          int all)
{
