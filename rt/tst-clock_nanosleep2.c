...
static void ptime_1(const char *n, struct timespec t)
{
...
static void test_interval_1(const char *n_clock, clockid_t t_clock)
{
...
static void test_abs_1(const char *n_clock, clockid_t t_clock)
{
...
static void test_invalids_1(const char *the_clock_name, int the_clock,
