...
extern mach_port_t _hurd_port_locked_get(struct hurd_port *port,
...
extern mach_port_t _hurd_port_get(struct hurd_port *port,
                                  struct hurd_userlink *link);
...
extern void _hurd_port_move(struct hurd_port *port,
                            struct hurd_userlink *new_link,
                            struct hurd_userlink *link);

#if defined __USE_EXTERN_INLINES && defined _LIBC
# if IS_IN (libc)
_HURD_PORT_H_EXTERN_INLINE void _hurd_port_move(struct hurd_port *port,
        struct hurd_userlink *new_link,
        struct hurd_userlink *link)
{
    HURD_CRITICAL_BEGIN;
...
extern void _hurd_port_free(struct hurd_port *port,
                            struct hurd_userlink *link,
