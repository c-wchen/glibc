...
static char *describe_number(char *description, const char *flavor, long int i, size_t size)
{
    unsigned long int j;
...
static char *describe_port(char *description, mach_port_t port, size_t size)
{
    int i;
...
kern_return_t _S_msg_describe_ports(mach_port_t msgport, mach_port_t refport,
