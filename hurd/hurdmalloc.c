...
static void attribute_used_retain malloc_init(void)
{
    int i;
...
void _hurd_malloc_fork_prepare(void)
/*
...
void _hurd_malloc_fork_parent(void)
/*
...
void _hurd_malloc_fork_child(void)
/*
