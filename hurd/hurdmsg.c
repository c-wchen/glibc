...
kern_return_t _S_msg_get_init_port(mach_port_t msgport, mach_port_t auth, int which,
...
kern_return_t _S_msg_set_init_port(mach_port_t msgport, mach_port_t auth,
...
kern_return_t _S_msg_get_init_ports(mach_port_t msgport, mach_port_t auth,
                                    mach_port_t **ports,
...
kern_return_t _S_msg_set_init_ports(mach_port_t msgport, mach_port_t auth,
...
kern_return_t _S_msg_get_init_int(mach_port_t msgport, mach_port_t auth,
                                  int which, int *value)
{
    error_t err;
...
kern_return_t _S_msg_get_init_ints(mach_port_t msgport, mach_port_t auth,
...
kern_return_t _S_msg_set_init_int(mach_port_t msgport, mach_port_t auth,
                                  int which, int value)
{
    error_t err;
...
kern_return_t _S_msg_set_init_ints(mach_port_t msgport, mach_port_t auth,
...
kern_return_t _S_msg_get_fd(mach_port_t msgport, mach_port_t auth, int which,
                            mach_port_t *result, mach_msg_type_name_t *result_type)
{
    AUTHCHECK;
...
kern_return_t _S_msg_set_fd(mach_port_t msgport, mach_port_t auth,
                            int which, mach_port_t port)
{
    error_t err;
...
kern_return_t _S_msg_set_env_variable(mach_port_t msgport, mach_port_t auth,
                                      const_string_t variable,
...
kern_return_t _S_msg_get_environment(mach_port_t msgport,
                                     char **data, mach_msg_type_number_t *datalen)
{
...
kern_return_t _S_msg_set_environment(mach_port_t msgport, mach_port_t auth,
...
kern_return_t _S_msg_set_dtable(mach_port_t process,
                                mach_port_t refport,
