...
static unsigned long get_svcr(void)
{
...
static unsigned long get_svl(void)
{
    register unsigned long x0 asm("x0");
    asm volatile(
...
/* Set tpidr2 to BLK.  */
static void set_tpidr2(struct blk *blk)
{
