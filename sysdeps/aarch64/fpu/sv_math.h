...
/* Double precision.  */
static inline svint64_t sv_s64(int64_t x)
{
    return svdup_n_s64(x);
}

static inline svuint64_t sv_u64(uint64_t x)
{
    return svdup_n_u64(x);
}

static inline svfloat64_t sv_f64(double x)
{
    return svdup_n_f64(x);
}

static inline svfloat64_t sv_call_f64(double (*f)(double), svfloat64_t x, svfloat64_t y, svbool_t cmp)
{
...
static inline svfloat64_t sv_call2_f64(double (*f)(double, double), svfloat64_t x1, svfloat64_t x2,
...
static inline svuint64_t sv_mod_n_u64_x(svbool_t pg, svuint64_t x, uint64_t y)
{
...
/* Single precision.  */
static inline svint32_t sv_s32(int32_t x)
{
    return svdup_n_s32(x);
}

static inline svuint32_t sv_u32(uint32_t x)
{
    return svdup_n_u32(x);
}

static inline svfloat32_t sv_f32(float x)
{
    return svdup_n_f32(x);
}

static inline svfloat32_t sv_call_f32(float (*f)(float), svfloat32_t x, svfloat32_t y, svbool_t cmp)
{
    svbool_t p = svpfirst(cmp, svpfalse());
    while (svptest_any(cmp, p)) {
...
static inline svfloat32_t sv_call2_f32(float (*f)(float, float), svfloat32_t x1, svfloat32_t x2,
