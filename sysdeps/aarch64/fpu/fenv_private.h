...
static __always_inline void libc_feholdexcept_aarch64(fenv_t *envp)
{
    fpu_control_t fpcr;
...
static __always_inline void libc_fesetround_aarch64(int round)
{
    fpu_control_t fpcr;
...
static __always_inline void libc_feholdexcept_setround_aarch64(fenv_t *envp, int round)
{
    fpu_control_t fpcr;
    fpu_control_t new_fpcr;
    fpu_fpsr_t fpsr;
...
static __always_inline int libc_fetestexcept_aarch64(int ex)
{
    fpu_fpsr_t fpsr;
...
static __always_inline void libc_fesetenv_aarch64(const fenv_t *envp)
{
    fpu_control_t fpcr;
    fpu_control_t new_fpcr;
...
static __always_inline int libc_feupdateenv_test_aarch64(const fenv_t *envp, int ex)
{
    fpu_control_t fpcr;
    fpu_control_t new_fpcr;
    fpu_fpsr_t fpsr;
...
static __always_inline void libc_feupdateenv_aarch64(const fenv_t *envp)
{
...
static __always_inline void libc_feholdsetround_aarch64(fenv_t *envp, int round)
{
    fpu_control_t fpcr;
    fpu_fpsr_t fpsr;
...
static __always_inline void libc_feresetround_aarch64(fenv_t *envp)
{
    fpu_control_t fpcr;
    int round;
...
static __always_inline void libc_feholdsetround_aarch64_ctx(struct rm_ctx *ctx, int r)
{
    fpu_control_t fpcr;
    int round;
...
static __always_inline void libc_feresetround_aarch64_ctx(struct rm_ctx *ctx)
{
...
static __always_inline void libc_feholdsetround_noex_aarch64_ctx(struct rm_ctx *ctx, int r)
{
    fpu_control_t fpcr;
    fpu_fpsr_t fpsr;
    int round;
...
static __always_inline void libc_feresetround_noex_aarch64_ctx(struct rm_ctx *ctx)
{
    /* Restore the rounding mode if updated.  */
    if (__glibc_unlikely(ctx->updated_status)) {
        _FPU_SETCW(ctx->env.__fpcr);
