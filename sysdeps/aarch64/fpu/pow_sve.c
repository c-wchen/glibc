...
static inline svbool_t sv_isint(svbool_t pg, svfloat64_t x)
{
    return svcmpeq(pg, svrintz_z(pg, x), x);
}

/* Check if x is real not integer valued.  */
static inline svbool_t sv_isnotint(svbool_t pg, svfloat64_t x)
{
    return svcmpne(pg, svrintz_z(pg, x), x);
}

/* Check if x is an odd integer.  */
static inline svbool_t sv_isodd(svbool_t pg, svfloat64_t x)
{
...
static inline svuint64_t sv_top12(svfloat64_t x)
{
...
/* Returns 1 if input is the bit representation of 0, infinity or nan.  */
static inline svbool_t sv_zeroinfnan(svbool_t pg, svuint64_t i)
{
...
static inline svfloat64_t sv_call_specialcase(svfloat64_t x1, svuint64_t u1, svuint64_t u2,
...
static inline svfloat64_t sv_log_inline(svbool_t pg, svuint64_t ix, svfloat64_t *tail,
                                        const struct data *d)
{
...
static inline svfloat64_t sv_exp_core(svbool_t pg, svfloat64_t x, svfloat64_t xtail,
...
static inline svfloat64_t sv_exp_inline(svbool_t pg, svfloat64_t x, svfloat64_t xtail,
...
static inline double pow_sc(double x, double y)
{
