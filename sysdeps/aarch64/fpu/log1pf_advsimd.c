...
static float32x4_t NOINLINE VPCS_ATTR special_case(float32x4_t x, uint32x4_t cmp, const struct data *d)
{
...
static float32x4_t NOINLINE VPCS_ATTR special_case(float32x4_t x, uint32x4_t cmp)
{
