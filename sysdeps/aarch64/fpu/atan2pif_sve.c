...
static svfloat32_t NOINLINE special_case(svfloat32_t y, svfloat32_t x, svfloat32_t ret,
        const svbool_t cmp)
{
...
static inline svbool_t zeroinfnan(svuint32_t i, const svbool_t pg, const struct data *d)
{
