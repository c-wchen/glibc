...
static float64x2_t VPCS_ATTR NOINLINE special_case(float64x2_t y, float64x2_t x, float64x2_t ret,
...
static inline uint64x2_t zeroinfnan(uint64x2_t i, const struct data *d)
{
