...
static float32x4_t VPCS_ATTR NOINLINE special_case(float32x4_t y, float32x4_t x, float32x4_t ret,
...
static inline uint32x4_t zeroinfnan(uint32x4_t i, const struct data *d)
{
