...
static inline svfloat64_t exp_over_two_inline(const svbool_t pg, svfloat64_t x, const struct data *d)
{
    /* Calculate exp(x).  */
...
static svfloat64_t NOINLINE special_case(svbool_t pg, svbool_t special, svfloat64_t ax, svfloat64_t t,
        const struct data *d)
{
