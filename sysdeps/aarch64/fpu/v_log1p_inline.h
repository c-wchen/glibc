...
static inline float64x2_t eval_poly(float64x2_t m, float64x2_t m2, const struct v_log1p_data *d)
{
...
static inline float64x2_t log1p_inline(float64x2_t x, const struct v_log1p_data *d)
{
