...
const static struct data {
    ...
    .poly = {
        0x1.c14e8ee44767p - 2, 0x1.dd2d3f99e4c0ep - 1, -0x1.08e83026b7e74p - 1,
...
static inline svfloat64_t shifted_lookup(const svbool_t pg, const float64_t *table, svint64_t i)
{
