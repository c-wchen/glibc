...
static const struct data {
    ...
    .poly = {
        V2(0x1.62e42fefa3686p - 1), V2(0x1.ebfbdff82c241p - 3),
...
static inline uint64x2_t lookup_sbits(uint64x2_t i)
{
    return (uint64x2_t) {
        __v_exp_data[i[0] & IndexMask],
...
static float64x2_t VPCS_ATTR NOINLINE special_case(float64x2_t x, float64x2_t y, uint64x2_t is_special)
{
...
static inline float64x2_t VPCS_ATTR special_case(float64x2_t s, float64x2_t y, float64x2_t n,
        const struct data *d)
{
