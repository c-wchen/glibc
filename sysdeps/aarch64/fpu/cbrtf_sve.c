...
const static struct data {
     ...
     */
    .poly = {
        0x1.c14e96p - 2, 0x1.dd2d3p - 1, -0x1.08e81ap - 1,
        0x1.2c74c2p - 3,
    },
    /* table[i] = 2^((i - 2) / 3).  */
...
static svfloat32_t NOINLINE special_case(svfloat32_t x, svfloat32_t y, svbool_t special)
{
    return sv_call_f32(cbrtf, x, y, special);
}

static inline svfloat32_t shifted_lookup(const svbool_t pg, const float32_t *table, svint32_t i)
{
