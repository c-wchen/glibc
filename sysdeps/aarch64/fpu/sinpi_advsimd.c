...
static const struct data {
    ...
    .poly = {
        V2(0x1.921fb54442d184p1), V2(-0x1.4abbce625be53p2),
...
static float64x2_t VPCS_ATTR NOINLINE special_case(float64x2_t x, float64x2_t y, uint64x2_t odd, uint64x2_t cmp)
{
