...
static const struct data {
    ...
    .poly = {
        V2(0x1.fffffffffffd4p - 2), V2(0x1.5555571d6b68cp - 3),
...
static float64x2_t NOINLINE VPCS_ATTR special_case(float64x2_t x, float64x2_t y, uint64x2_t special)
{
...
static inline float64x2_t exp_inline(float64x2_t x)
{
