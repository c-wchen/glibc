...
static void fail(struct link_map *l, const char *program)
{
...
static bool check_gcs(struct link_map *l, const char *program, bool enforced)
{
#ifdef SHARED
...
static void check_gcs_depends(struct link_map *l, const char *program, bool enforced)
{
...
void _dl_gcs_check(struct link_map *l, const char *program)
{
