...
void _dl_bti_protect(struct link_map *map, int fd)
{
...
static void bti_failed(struct link_map *l, const char *program)
{
    if (program)
...
void _dl_bti_check(struct link_map *l, const char *program)
{
