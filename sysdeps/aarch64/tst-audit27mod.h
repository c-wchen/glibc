...
double tst_audit27_func_double(double a0, double a1, double a2, double a3, double a4,
...
long double tst_audit27_func_ldouble(long double a0, long double a1, long double a2,
