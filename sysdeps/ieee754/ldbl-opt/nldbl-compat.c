...
int
attribute_compat_text_section __nldbl_fprintf(FILE *stream, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_printf(const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_obstack_printf(struct obstack *obstack, const char *fmt, ...)
{
    int ret;
    va_list ap;
    va_start(ap, fmt);
...
int
attribute_compat_text_section weak_function __nldbl_snprintf(char *s, size_t maxlen, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_swprintf(wchar_t *s, size_t n, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section weak_function __nldbl_vasprintf(char **result_ptr, const char *fmt, va_list ap)
{
    return __vasprintf_internal(result_ptr, fmt, ap, PRINTF_LDBL_IS_DBL);
}

int
attribute_compat_text_section __nldbl_vdprintf(int d, const char *fmt, va_list ap)
{
    return __vdprintf_internal(d, fmt, ap, PRINTF_LDBL_IS_DBL);
}

int
attribute_compat_text_section weak_function __nldbl_vfwprintf(FILE *s, const wchar_t *fmt, va_list ap)
{
    return __vfwprintf_internal(s, fmt, ap, PRINTF_LDBL_IS_DBL);
}

int
attribute_compat_text_section __nldbl_vprintf(const char *fmt, va_list ap)
{
    return __vfprintf_internal(stdout, fmt, ap, PRINTF_LDBL_IS_DBL);
}

int
attribute_compat_text_section __nldbl_vsnprintf(char *string, size_t maxlen, const char *fmt,
        va_list ap)
{
...
int
attribute_compat_text_section __nldbl_vwprintf(const wchar_t *fmt, va_list ap)
{
    return __vfwprintf_internal(stdout, fmt, ap, PRINTF_LDBL_IS_DBL);
}

int
attribute_compat_text_section __nldbl_wprintf(const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl__IO_vfscanf(FILE *s, const char *fmt, va_list ap, int *errp)
{
...
int
attribute_compat_text_section __nldbl___vfscanf(FILE *s, const char *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl_fscanf(FILE *stream, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_scanf(const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_vfwscanf(FILE *s, const wchar_t *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl_vswscanf(const wchar_t *s, const wchar_t *fmt, va_list ap)
{
    _IO_strfile sf;
    struct _IO_wide_data wd;
    FILE *f = _IO_strfile_readw(&sf, &wd, s);
...
int
attribute_compat_text_section __nldbl_fwscanf(FILE *stream, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_wscanf(const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___fprintf_chk(FILE *stream, int flag, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___fwprintf_chk(FILE *stream, int flag, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
...
int
attribute_compat_text_section __nldbl___printf_chk(int flag, const char *fmt, ...)
{
    va_list ap;
    int ret;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
...
int
attribute_compat_text_section __nldbl___snprintf_chk(char *s, size_t maxlen, int flag, size_t slen,
        const char *fmt, ...)
{
...
int
attribute_compat_text_section __nldbl___sprintf_chk(char *s, int flag, size_t slen, const char *fmt, ...)
{
    if (slen == 0) {
        __chk_fail();
    }
...
int
attribute_compat_text_section __nldbl___swprintf_chk(wchar_t *s, size_t maxlen, int flag, size_t slen,
        const wchar_t *fmt, ...)
{
    if (__glibc_unlikely(slen < maxlen)) {
        __chk_fail();
...
int
attribute_compat_text_section __nldbl___vfprintf_chk(FILE *s, int flag, const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___vfwprintf_chk(FILE *s, int flag, const wchar_t *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___vprintf_chk(int flag, const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___vsnprintf_chk(char *string, size_t maxlen, int flag, size_t slen,
...
int
attribute_compat_text_section __nldbl___vsprintf_chk(char *string, int flag, size_t slen, const char *fmt,
        va_list ap)
{
    if (slen == 0) {
        __chk_fail();
...
int
attribute_compat_text_section __nldbl___vswprintf_chk(wchar_t *string, size_t maxlen, int flag, size_t slen,
...
int
attribute_compat_text_section __nldbl___vwprintf_chk(int flag, const wchar_t *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___wprintf_chk(int flag, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
...
int
attribute_compat_text_section __nldbl___vasprintf_chk(char **ptr, int flag, const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___asprintf_chk(char **ptr, int flag, const char *fmt, ...)
{
    va_list ap;
    int ret;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
...
int
attribute_compat_text_section __nldbl___vdprintf_chk(int d, int flag, const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___dprintf_chk(int d, int flag, const char *fmt, ...)
{
    va_list ap;
    int ret;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
...
int
attribute_compat_text_section __nldbl___obstack_vprintf_chk(struct obstack *obstack, int flag,
        const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
...
int
attribute_compat_text_section __nldbl___obstack_printf_chk(struct obstack *obstack, int flag,
        const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl_printf_size(FILE *fp, const struct printf_info *info,
...
int
attribute_compat_text_section __nldbl___printf_fp(FILE *fp, const struct printf_info *info,
        const void *const *args)
{
    struct printf_info info_no_ldbl = *info;
...
ssize_t
attribute_compat_text_section __nldbl_strfmon(char *s, size_t maxsize, const char *format, ...)
{
    va_list ap;
    ssize_t ret;
...
ssize_t
attribute_compat_text_section __nldbl___strfmon_l(char *s, size_t maxsize, locale_t loc,
        const char *format, ...)
{
    va_list ap;
    ssize_t ret;
...
ssize_t
attribute_compat_text_section __nldbl___vstrfmon_l(char *s, size_t maxsize, locale_t loc,
...
void
attribute_compat_text_section __nldbl_syslog(int pri, const char *fmt, ...)
{
    va_list ap;
    va_start(ap, fmt);
...
void
attribute_compat_text_section __nldbl_vsyslog(int pri, const char *fmt, va_list ap)
{
    __vsyslog_internal(pri, fmt, ap, PRINTF_LDBL_IS_DBL);
}

void
attribute_compat_text_section __nldbl___syslog_chk(int pri, int flag, const char *fmt, ...)
{
    va_list ap;
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
...
void
attribute_compat_text_section __nldbl___vsyslog_chk(int pri, int flag, const char *fmt, va_list ap)
{
    unsigned int mode = PRINTF_LDBL_IS_DBL;
    if (flag > 0) {
        mode |= PRINTF_FORTIFY;
...
int
attribute_compat_text_section __nldbl___isoc99_vfscanf(FILE *s, const char *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl___isoc99_vsscanf(const char *s, const char *fmt, va_list ap)
{
    _IO_strfile sf;
    FILE *f = _IO_strfile_read(&sf, s);
...
int
attribute_compat_text_section __nldbl___isoc99_fscanf(FILE *s, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc99_scanf(const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc99_vfwscanf(FILE *s, const wchar_t *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl___isoc99_vswscanf(const wchar_t *s, const wchar_t *fmt, va_list ap)
{
    _IO_strfile sf;
    struct _IO_wide_data wd;
    FILE *f = _IO_strfile_readw(&sf, &wd, s);
...
int
attribute_compat_text_section __nldbl___isoc99_fwscanf(FILE *s, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc99_wscanf(const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc23_vfscanf(FILE *s, const char *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl___isoc23_vsscanf(const char *s, const char *fmt, va_list ap)
{
    _IO_strfile sf;
    FILE *f = _IO_strfile_read(&sf, s);
...
int
attribute_compat_text_section __nldbl___isoc23_fscanf(FILE *s, const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc23_scanf(const char *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc23_vfwscanf(FILE *s, const wchar_t *fmt, va_list ap)
{
...
int
attribute_compat_text_section __nldbl___isoc23_vswscanf(const wchar_t *s, const wchar_t *fmt, va_list ap)
{
    _IO_strfile sf;
    struct _IO_wide_data wd;
    FILE *f = _IO_strfile_readw(&sf, &wd, s);
...
int
attribute_compat_text_section __nldbl___isoc23_fwscanf(FILE *s, const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
int
attribute_compat_text_section __nldbl___isoc23_wscanf(const wchar_t *fmt, ...)
{
    va_list ap;
    int ret;
...
void __nldbl_argp_error(const struct argp_state *state, const char *fmt, ...)
{
    va_list ap;
    va_start(ap, fmt);
...
void __nldbl_argp_failure(const struct argp_state *state, int status,
...
void __nldbl_errx(int status, const char *format, ...)
{
    VA_CALL(__vwarnx_internal)
    exit(status);
}

void __nldbl_verr(int status, const char *format, __gnuc_va_list ap)
{
    __vwarn_internal(format, ap, PRINTF_LDBL_IS_DBL);
    exit(status);
}

void __nldbl_verrx(int status, const char *format, __gnuc_va_list ap)
{
    __vwarnx_internal(format, ap, PRINTF_LDBL_IS_DBL);
    exit(status);
}

void __nldbl_warn(const char *format, ...)
{
    VA_CALL(__vwarn_internal)
}

void __nldbl_warnx(const char *format, ...)
{
    VA_CALL(__vwarnx_internal)
}

void __nldbl_vwarn(const char *format, __gnuc_va_list ap)
{
    __vwarn_internal(format, ap, PRINTF_LDBL_IS_DBL);
}

void __nldbl_vwarnx(const char *format, __gnuc_va_list ap)
{
    __vwarnx_internal(format, ap, PRINTF_LDBL_IS_DBL);
}

void __nldbl_error(int status, int errnum, const char *message, ...)
{
    va_list ap;
    va_start(ap, message);
...
void __nldbl_error_at_line(int status, int errnum, const char *file_name,
