...
static _Float128 lg_sinpi(_Float128 x)
{
    if (x <= L(0.25)) {
...
static _Float128 lg_cospi(_Float128 x)
{
    if (x <= L(0.25)) {
...
static _Float128 lg_cotpi(_Float128 x)
{
...
_Float128 __lgamma_negl(_Float128 x, int *signgamp)
{
