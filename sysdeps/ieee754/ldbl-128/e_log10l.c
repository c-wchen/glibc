...
static _Float128 neval(_Float128 x, const _Float128 *p, int n)
{
    _Float128 y;
...
static _Float128 deval(_Float128 x, const _Float128 *p, int n)
{
    _Float128 y;
...
_Float128 __ieee754_log10l(_Float128 x)
{
    _Float128 z;
    _Float128 y;
    int e;
