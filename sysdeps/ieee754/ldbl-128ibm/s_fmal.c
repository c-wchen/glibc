...
static void add_split(double *hi, double *lo, double x, double y)
{
...
static void store_ext_val(ext_val *v, double d)
{
...
static void mul_ext_val(ext_val *v0, ext_val *v1, double x, double y)
{
    int xexp, yexp;
    x = __frexp(x, &xexp);
    y = __frexp(y, &yexp);
...
static void add_split_ext(ext_val *x, ext_val *y)
{
