...
static inline void ldbl_extract_mantissa(int64_t *hi64, uint64_t *lo64, int *exp, long double x)
{
...
static inline long double ldbl_insert_mantissa(int sign, int exp, int64_t hi64, uint64_t lo64)
{
    union ibm_extended_long_double u;
    int expnt2;
    uint64_t hi, lo;
...
static inline long double default_ldbl_pack(double a, double aa)
{
    union ibm_extended_long_double u;
    u.d[0].d = a;
    u.d[1].d = aa;
...
static inline void default_ldbl_unpack(long double l, double *a, double *aa)
{
    union ibm_extended_long_double u;
    u.ld = l;
    *a = u.d[0].d;
...
static inline void ldbl_canonicalize(double *a, double *aa)
{
    double xh, xl;
...
static inline double ldbl_nearbyint(double a)
{
    double two52 = 0x1p52;
...
/* Canonicalize a result from an integer rounding function, in any
   ...
   *A.  */
static inline void ldbl_canonicalize_int(double *a, double *aa)
{
