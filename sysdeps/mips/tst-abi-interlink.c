...
static struct fp_mode_req compute_fp_modes(enum fp_state state)
{
...
static bool current_mode_valid_p(enum fp_state s)
{
...
static bool set_next_fp_state(enum fp_obj obj)
{
...
static bool remove_object(enum fp_obj obj)
{
    if (obj == o_max) {
        return false;
    }
...
static int mode_transition_valid_p(void)
{
    int prev_fp_mode;
...
bool load_object(enum fp_obj obj)
{
...
bool unload_object(enum fp_obj obj)
{
...
static bool test_permutations(enum fp_obj objects[], int count)
{
    int i;
