...
static bool cached_fpabi_reject_phdr_p(struct link_map *l)
{
    if (l->l_mach.fpabi == 0) {
...
static const char *fpabi_string(int fpabi)
{
    switch (fpabi) {
...
static bool __attribute_used__ elf_machine_reject_phdr_p(const ElfW(Phdr) *phdr, unsigned int phnum,
