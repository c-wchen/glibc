...
static inline Elf32_Addr elf_machine_plt_value(struct link_map *map, const Elf32_Rel *reloc,
        Elf32_Addr value)
{
    return value;
}
...
static void relocate_pc24(struct link_map *map, Elf32_Addr value,
