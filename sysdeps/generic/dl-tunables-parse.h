...
/* Compare the contents of STRVAL with STR of size LEN.  The STR might not
   be null-terminated.   */
static __always_inline bool tunable_strcmp(const struct tunable_str_t *strval, const char *str,
        size_t len)
{
...
static inline void tunable_str_comma_init(struct tunable_str_comma_state_t *state,
        tunable_val_t *valp)
{
...
static inline bool tunable_str_comma_next(struct tunable_str_comma_state_t *state,
...
/* Compare the contents of T with STR of size LEN.  The STR might not be
   null-terminated.   */
static __always_inline bool tunable_str_comma_strcmp(const struct tunable_str_comma_t *t, const char *str,
        size_t len)
{
