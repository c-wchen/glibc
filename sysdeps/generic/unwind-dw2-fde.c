...
static void init_object_mutex(void)
{
...
static inline int get_fde_encoding(struct dwarf_fde *f)
{
...
static inline _Unwind_Ptr get_pc_begin(fde *x, size_t n)
{
    _Unwind_Ptr p;
...
static inline void fde_insert(struct fde_accumulator *accu, fde *this_fde)
{
    if (accu->linear) {
...
static void fde_split(struct object *ob, fde_compare_t fde_compare,
...
static void frame_heapsort(struct object *ob, fde_compare_t fde_compare,
                           struct fde_vector *erratic)
{
...
static void fde_merge(struct object *ob, fde_compare_t fde_compare,
...
static fde *linear_search_fdes(struct object *ob, fde *this_fde, void *pc)
{
    struct dwarf_cie *last_cie = 0;
    int encoding = ob->s.b.encoding;
    _Unwind_Ptr base = base_from_object(ob->s.b.encoding, ob);
...
static fde *binary_search_unencoded_fdes(struct object *ob, void *pc)
{
...
static fde *binary_search_single_encoding_fdes(struct object *ob, void *pc)
{
    struct fde_vector *vec = ob->u.sort;
    int encoding = ob->s.b.encoding;
...
static fde *binary_search_mixed_encoding_fdes(struct object *ob, void *pc)
{
    struct fde_vector *vec = ob->u.sort;
    size_t lo, hi;
...
static fde *search_object(struct object *ob, void *pc)
{
