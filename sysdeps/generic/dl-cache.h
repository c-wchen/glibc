...
static inline bool dl_cache_hwcap_extension(struct file_entry_new *entry)
{
...
/* Returns false if *CACHE has the wrong endianness for this
   ...
   unknown).  */
static inline bool cache_file_new_matches_endian(const struct cache_file_new *cache)
{
...
static void cache_extension_verify(struct cache_extension_all_loaded *loaded)
{
    {
