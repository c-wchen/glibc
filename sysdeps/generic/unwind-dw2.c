...
inline _Unwind_Word _Unwind_GetGR(struct _Unwind_Context *context, int index)
{
...
inline void _Unwind_SetGR(struct _Unwind_Context *context, int index, _Unwind_Word val)
{
...
inline void _Unwind_SetIP(struct _Unwind_Context *context, _Unwind_Ptr val)
{
    context->ra = (void *) val;
}
...
static const unsigned char *extract_cie_info(struct dwarf_cie *cie, struct _Unwind_Context *context,
...
static _Unwind_Word execute_stack_op(const unsigned char *op_ptr, const unsigned char *op_end,
...
static inline _Unwind_Ptr uw_identify_context(struct _Unwind_Context *context)
{
