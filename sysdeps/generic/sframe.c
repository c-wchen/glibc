...
static inline _Unwind_Ptr read_stack_value(_Unwind_Ptr loc)
{
...
static int _dl_find_object_helper(void *address, struct dl_find_object *result)
{
...
int __stacktrace_sframe(void **ra_lst, int count, frame *frame)
{
