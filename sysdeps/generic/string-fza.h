...
static __always_inline find_t find_zero_low(op_t x)
{
...
static __always_inline find_t find_eq_low(op_t x1, op_t x2)
{
...
static __always_inline find_t find_zero_eq_low(op_t x1, op_t x2)
{
