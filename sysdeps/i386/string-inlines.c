...
void *__old_memcpy_c(void *d, const void *s, size_t n)
{
    return memcpy(d, s, n);
}
...
void *__old_memset_cc(void *s, unsigned long int pattern, size_t n)
{
...
void *__old_memset_gg(void *s, char c, size_t n)
{
    return memset(s, c, n);
}
...
size_t __old_strlen_g(const char *str)
{
    return strlen(str);
}
compat_symbol(libc, __old_strlen_g, __strlen_g, GLIBC_2_1_1);

char *__old_strcpy_g(char *dest, const char *src)
{
    return strcpy(dest, src);
}
compat_symbol(libc, __old_strcpy_g, __strcpy_g, GLIBC_2_1_1);

void *__old_mempcpy_byn(void *dest, const void *src, size_t len)
{
...
char *__old_stpcpy_g(char *dest, const char *src)
{
    return __stpcpy(dest, src);
}
compat_symbol(libc, __old_stpcpy_g, __stpcpy_g, GLIBC_2_1_1);

char *__old_strncpy_byn(char *dest, const char *src, size_t srclen, size_t n)
{
...
char *__old_strncpy_gg(char *dest, const char *src, size_t n)
{
    return strncpy(dest, src, n);
}
...
char *__old_strcat_g(char *dest, const char *src)
{
...
char *__old_strchrnul_g(const char *s, int c)
{
...
char *__old_strrchr_g(const char *s, int c)
{
    return strrchr(s, c);
}
...
size_t __old_strcspn_g(const char *s, const char *reject)
{
...
size_t __old_strspn_g(const char *s, const char *accept)
{
...
const char *__old_strpbrk_g(const char *s, const char *accept)
{
...
const char *__old_strstr_g(const char *s, const char *accept)
{
