...
static __always_inline void libc_feholdexcept_or1k(fenv_t *envp)
{
    fpu_control_t cw;
...
static __always_inline void libc_fesetround_or1k(int round)
{
    fpu_control_t cw;
    fpu_control_t cw_new;
...
static __always_inline void libc_feholdexcept_setround_or1k(fenv_t *envp, int round)
{
    fpu_control_t cw;
    fpu_control_t cw_new;
...
static __always_inline int libc_fetestexcept_or1k(int ex)
{
    fpu_control_t cw;
...
static __always_inline void libc_fesetenv_or1k(const fenv_t *envp)
{
    if (envp == FE_DFL_ENV) {
...
static __always_inline int libc_feupdateenv_test_or1k(const fenv_t *envp, int ex)
{
    fpu_control_t cw;
    fpu_control_t cw_new;
    int excepts;
...
static __always_inline void libc_feupdateenv_or1k(const fenv_t *envp)
{
...
static __always_inline void libc_feholdsetround_or1k(fenv_t *envp, int round)
{
    fpu_control_t cw;
...
static __always_inline void libc_feresetround_or1k(fenv_t *envp)
{
    fpu_control_t cw;
    int round;
