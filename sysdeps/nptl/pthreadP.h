...
static __always_inline void __pthread_cleanup_combined_routine(struct __pthread_cleanup_combined_frame
        *__frame)
{
    if (__frame->__do_it) {
...
static inline void __pthread_cleanup_combined_routine_voidptr(void *__arg)
{
...
static inline int check_sched_priority_attr(int pr, int pol)
{
