...
int __sem_timedwait_internal(sem_t *restrict sem,
                             clockid_t clock_id,
...
int __sem_clockwait(sem_t *sem, clockid_t clockid,
                    const struct timespec *restrict timeout)
{
...
int __sem_timedwait(sem_t *restrict sem, const struct timespec *restrict timeout)
{
