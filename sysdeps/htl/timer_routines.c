...
static inline void list_append(struct list_head *list, struct list_head *newp)
{
    newp->prev = list->prev;
    newp->next = list;
    list->prev->next = newp;
...
static inline void list_insbefore(struct list_head *list, struct list_head *newp)
{
...
static inline void list_unlink(struct list_head *list)
{
...
static inline struct list_head *list_null(struct list_head *list)
{
    return list;
}
...
static inline int list_isempty(struct list_head *list)
{
...
static inline struct thread_node *thread_links2ptr(struct list_head *list)
{
    return (struct thread_node *)((char *) list
                                  - offsetof(struct thread_node, links));
}

static inline struct timer_node *timer_links2ptr(struct list_head *list)
{
