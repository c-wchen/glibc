...
static unsigned long int pc_to_index(size_t pc, size_t offset, unsigned int scale, int prof_uint)
{
...
static inline size_t index_to_pc(unsigned long int n, size_t offset, unsigned int scale,
                                 int prof_uint)
{
...
static void profil_count(uintptr_t pcp, int prof_uint)
{
...
static int insert(int i, unsigned long int start, unsigned long int end, struct prof *p,
                  int prof_uint)
{
    struct region *r;
    size_t to_copy;
...
static int add_region(struct prof *p, int prof_uint)
{
...
static int pcmp(const void *left, const void *right)
{
