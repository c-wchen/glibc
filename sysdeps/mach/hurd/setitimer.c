...
static inline void subtract_timeval(struct timeval *from, const struct timeval *subtract)
{
...
static sighandler_t restart_itimer(struct hurd_signal_preemptor *preemptor,
...
static int setitimer_locked(const struct itimerval *new, struct itimerval *old,
