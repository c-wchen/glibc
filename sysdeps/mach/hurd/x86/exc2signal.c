...
static void exception2signal(struct hurd_signal_detail *detail, int *signo, int posix)
{
    detail->error = 0;
...
void _hurd_exception2signal_legacy(struct hurd_signal_detail *detail, int *signo)
{
