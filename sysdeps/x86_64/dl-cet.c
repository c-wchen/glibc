...
static void dl_check_legacy_object(struct link_map *m,
...
static void dl_cet_check_startup(struct link_map *m, struct dl_cet_info *info)
{
...
static void dl_cet_check_dlopen(struct link_map *m, struct dl_cet_info *info)
{
...
static void dl_cet_check(struct link_map *m, const char *program)
{
    struct dl_cet_info info;
...
void _dl_cet_open_check(struct link_map *l)
{
    dl_cet_check(l, NULL);
}
...
attribute_hidden void _dl_cet_setup_features(unsigned int cet_feature)
{
...
LINKAGE
void _dl_cet_check(struct link_map *main_map, const char *program)
{
