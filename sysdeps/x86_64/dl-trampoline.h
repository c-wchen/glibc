...
# endif
                                        ...
                                        mov 48( % rbx), % RDX_LP   # Load return address if needed.
                                                mov 40( % rbx)
                                                    , % RSI_LP   # Copy args pushed by PLT in register.
                                                mov 32( % rbx), % RDI_LP   # % rdi:
                                                link_map, % rsi:
                                                    reloc_index
...
# ifdef RESTORE_AVX
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET)( % rsp), % VEC(0)
                                                            vmovdqa % xmm0, (LR_XMM_OFFSET)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE)( % rsp), % xmm1, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE)( % rsp), % VEC(1)
                                                            vmovdqa % xmm1, (LR_XMM_OFFSET + XMM_SIZE)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 2)( % rsp), % xmm2, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 2)( % rsp), % VEC(2)
                                                            vmovdqa % xmm2, (LR_XMM_OFFSET + XMM_SIZE * 2)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 3)( % rsp), % xmm3, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 3)( % rsp), % VEC(3)
                                                            vmovdqa % xmm3, (LR_XMM_OFFSET + XMM_SIZE * 3)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 4)( % rsp), % xmm4, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 4)( % rsp), % VEC(4)
                                                            vmovdqa % xmm4, (LR_XMM_OFFSET + XMM_SIZE * 4)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 5)( % rsp), % xmm5, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 5)( % rsp), % VEC(5)
                                                            vmovdqa % xmm5, (LR_XMM_OFFSET + XMM_SIZE * 5)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 6)( % rsp), % xmm6, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 6)( % rsp), % VEC(6)
                                                            vmovdqa % xmm6, (LR_XMM_OFFSET + XMM_SIZE * 6)( % rsp)

                                                        1:
                                                            vpcmpeqb(LR_SIZE + XMM_SIZE * 7)( % rsp), % xmm7, % xmm8
                                                            vpmovmskb % xmm8, % esi
                                                            incw % si
                                                            je 2f
                                                            ...
                                                            jmp 1f
                                                        2:
                                                            VMOVA(LR_VECTOR_OFFSET + VECTOR_SIZE * 7)( % rsp), % VEC(7)
