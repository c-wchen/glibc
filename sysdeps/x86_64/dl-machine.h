...
static const char *x86_64_reloc_symbol_name(struct link_map *map, const ElfW(Rela) *reloc)
{
...
static void x86_64_rewrite_plt(struct link_map *map, ElfW(Addr) plt_rewrite)
{
...
static inline void x86_64_rewrite_plt_in_place(struct link_map *map)
{
...
static inline void x86_64_dynamic_after_reloc(struct link_map *map, int lazy)
{
