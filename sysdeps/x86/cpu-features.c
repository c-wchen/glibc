...
static void update_active(struct cpu_features *cpu_features)
{
...
static void get_extended_indices(struct cpu_features *cpu_features)
{
    unsigned int eax, ebx, ecx, edx;
...
static void get_common_indices(struct cpu_features *cpu_features,
