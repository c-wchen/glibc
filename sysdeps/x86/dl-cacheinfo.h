...
static void get_common_cache_info(long int *shared_ptr, long int *shared_per_thread_ptr, unsigned int *threads_ptr,
                                  long int core)
{
    unsigned int eax;
    unsigned int ebx;
...
static void dl_init_cacheinfo(struct cpu_features *cpu_features)
{
