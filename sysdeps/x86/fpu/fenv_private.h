...
static __always_inline void libc_feholdexcept_sse(fenv_t *e)
{
    unsigned int mxcsr;
...
static __always_inline void libc_feholdexcept_387(fenv_t *e)
{
...
static __always_inline void libc_fesetround_sse(int r)
{
    unsigned int mxcsr;
    asm(STMXCSR " %0" : "=m"( *&mxcsr));
...
static __always_inline void libc_fesetround_387(int r)
{
    fpu_control_t cw;
    _FPU_GETCW(cw);
    cw = (cw & ~0xc00) | r;
...
static __always_inline void libc_feholdexcept_setround_sse(fenv_t *e, int r)
{
    unsigned int mxcsr;
    asm(STMXCSR " %0" : "=m"( *&mxcsr));
    e->__mxcsr = mxcsr;
...
static __always_inline void libc_feholdexcept_setround_387_prec(fenv_t *e, int r)
{
...
static __always_inline void libc_feholdexcept_setround_387(fenv_t *e, int r)
{
    libc_feholdexcept_setround_387_prec(e, r | _FPU_EXTENDED);
}

static __always_inline void libc_feholdexcept_setround_387_53bit(fenv_t *e, int r)
{
    libc_feholdexcept_setround_387_prec(e, r | _FPU_DOUBLE);
}

static __always_inline int libc_fetestexcept_sse(int e)
{
    unsigned int mxcsr;
...
static __always_inline int libc_fetestexcept_387(int ex)
{
    fexcept_t temp;
...
static __always_inline void libc_fesetenv_sse(fenv_t *e)
{
    asm volatile(LDMXCSR " %0" : : "m"(e->__mxcsr));
}

static __always_inline void libc_fesetenv_387(fenv_t *e)
{
...
static __always_inline int libc_feupdateenv_test_sse(fenv_t *e, int ex)
{
...
static __always_inline int libc_feupdateenv_test_387(fenv_t *e, int ex)
{
    fexcept_t cur_ex;
...
static __always_inline void libc_feupdateenv_sse(fenv_t *e)
{
    libc_feupdateenv_test_sse(e, 0);
}

static __always_inline void libc_feupdateenv_387(fenv_t *e)
{
    libc_feupdateenv_test_387(e, 0);
}

static __always_inline void libc_feholdsetround_sse(fenv_t *e, int r)
{
    unsigned int mxcsr;
    asm(STMXCSR " %0" : "=m"( *&mxcsr));
    e->__mxcsr = mxcsr;
...
static __always_inline void libc_feholdsetround_387_prec(fenv_t *e, int r)
{
    fpu_control_t cw;
...
static __always_inline void libc_feholdsetround_387(fenv_t *e, int r)
{
    libc_feholdsetround_387_prec(e, r | _FPU_EXTENDED);
}

static __always_inline void libc_feholdsetround_387_53bit(fenv_t *e, int r)
{
    libc_feholdsetround_387_prec(e, r | _FPU_DOUBLE);
}

static __always_inline void libc_feresetround_sse(fenv_t *e)
{
    unsigned int mxcsr;
    asm(STMXCSR " %0" : "=m"( *&mxcsr));
...
static __always_inline void libc_feresetround_387(fenv_t *e)
{
...
static __always_inline void libc_feholdexcept_setround_sse_ctx(struct rm_ctx *ctx, int r)
{
...
/* Unconditional since we want to overwrite any exceptions that occurred in the
   ...
   ctx->env.  */
static __always_inline void libc_fesetenv_sse_ctx(struct rm_ctx *ctx)
{
    libc_fesetenv_sse(&ctx->env);
}

static __always_inline void libc_feupdateenv_sse_ctx(struct rm_ctx *ctx)
{
...
static __always_inline void libc_feholdexcept_setround_387_prec_ctx(struct rm_ctx *ctx, int r)
{
...
static __always_inline void libc_feholdexcept_setround_387_ctx(struct rm_ctx *ctx, int r)
{
    libc_feholdexcept_setround_387_prec_ctx(ctx, r | _FPU_EXTENDED);
}

static __always_inline void libc_feholdexcept_setround_387_53bit_ctx(struct rm_ctx *ctx, int r)
{
    libc_feholdexcept_setround_387_prec_ctx(ctx, r | _FPU_DOUBLE);
}

static __always_inline void libc_feholdsetround_387_prec_ctx(struct rm_ctx *ctx, int r)
{
...
static __always_inline void libc_feholdsetround_387_ctx(struct rm_ctx *ctx, int r)
{
    libc_feholdsetround_387_prec_ctx(ctx, r | _FPU_EXTENDED);
}

static __always_inline void libc_feholdsetround_387_53bit_ctx(struct rm_ctx *ctx, int r)
{
    libc_feholdsetround_387_prec_ctx(ctx, r | _FPU_DOUBLE);
}

static __always_inline void libc_feholdsetround_sse_ctx(struct rm_ctx *ctx, int r)
{
    unsigned int mxcsr, new_mxcsr;
...
static __always_inline void libc_feresetround_sse_ctx(struct rm_ctx *ctx)
{
    if (__glibc_unlikely(ctx->updated_status)) {
...
static __always_inline void libc_feresetround_387_ctx(struct rm_ctx *ctx)
{
    if (__glibc_unlikely(ctx->updated_status)) {
...
static __always_inline void libc_feupdateenv_387_ctx(struct rm_ctx *ctx)
{
    if (__glibc_unlikely(ctx->updated_status)) {
