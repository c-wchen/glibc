...
static uint16_t get_x87_cw(void)
{
    fpu_control_t cw;
    _FPU_GETCW(cw);
    return cw;
...
static void set_x87_cw(uint16_t val)
{
    fpu_control_t cw = val;
    _FPU_SETCW(cw);
}

static void set_x87_cw_bits(uint16_t mask, uint16_t bits)
{
...
static int test_x87_cw_bits(const char *test, uint16_t mask, uint16_t bits)
{
    uint16_t cw = get_x87_cw();
...
static uint16_t get_x87_sw(void)
{
    uint16_t temp;
...
static void set_x87_sw_bits(uint16_t mask, uint16_t bits)
{
    fenv_t temp;
...
static int test_x87_sw_bits(const char *test, uint16_t mask, uint16_t bits)
{
