...
static __always_inline void libc_fesetround_loongarch(int round)
{
    fpu_control_t cw;
...
static __always_inline void libc_feholdexcept_setround_loongarch(fenv_t *envp, int round)
{
    fpu_control_t cw;
...
static __always_inline void libc_fesetenv_loongarch(fenv_t *envp)
{
...
static __always_inline int libc_feupdateenv_test_loongarch(fenv_t *envp, int excepts)
{
...
static __always_inline void libc_feupdateenv_loongarch(fenv_t *envp)
{
...
static __always_inline int libc_fetestexcept_loongarch(int excepts)
{
    int cw;
...
static __always_inline void libc_feholdexcept_setround_loongarch_ctx(struct rm_ctx *ctx, int round)
{
...
static __always_inline void libc_feupdateenv_loongarch_ctx(struct rm_ctx *ctx)
{
...
static __always_inline void libc_feholdsetround_loongarch_ctx(struct rm_ctx *ctx, int round)
{
    fpu_control_t old, new;
