...
static __always_inline void libc_feholdexcept(fenv_t *e)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
    *(e) = etmp;
...
static __always_inline void libc_fesetround(int r)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
...
static __always_inline void libc_feholdexcept_setround(fenv_t *e, int r)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
    *(e) = etmp;
...
static __always_inline int libc_fetestexcept(int e)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
...
static __always_inline void libc_fesetenv(fenv_t *e)
{
    __fenv_ldfsr(*e);
}

static __always_inline int libc_feupdateenv_test(fenv_t *e, int ex)
{
    fenv_t etmp;
...
static __always_inline void libc_feupdateenv(fenv_t *e)
{
    libc_feupdateenv_test(e, 0);
}

static __always_inline void libc_feholdsetround(fenv_t *e, int r)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
    *(e) = etmp;
...
static __always_inline void libc_feresetround(fenv_t *e)
{
    fenv_t etmp;
    __fenv_stfsr(etmp);
...
static __always_inline void libc_feholdexcept_setround_sparc_ctx(struct rm_ctx *ctx, int round)
{
    fenv_t new;
...
static __always_inline void libc_fesetenv_sparc_ctx(struct rm_ctx *ctx)
{
    libc_fesetenv(&ctx->env);
}

static __always_inline void libc_feupdateenv_sparc_ctx(struct rm_ctx *ctx)
{
...
static __always_inline void libc_feholdsetround_sparc_ctx(struct rm_ctx *ctx, int round)
{
    fenv_t new;
