...
ssize_t ___mq_timedreceive_time64(mqd_t mqdes, char *__restrict msg_ptr, size_t msg_len,
...
ssize_t ___mq_timedreceive(mqd_t mqdes, char *__restrict msg_ptr, size_t msg_len,
                           unsigned int *__restrict msg_prio,
