...
static inline void stb_mb(unsigned char val, unsigned long addr)
{
    __asm__("stb %1,%0; mb" : "=m"(*(vucp)addr) : "r"(val));
}

static inline void stw_mb(unsigned short val, unsigned long addr)
{
    __asm__("stw %1,%0; mb" : "=m"(*(vusp)addr) : "r"(val));
}

static inline void stl_mb(unsigned int val, unsigned long addr)
{
    __asm__("stl %1,%0; mb" : "=m"(*(vip)addr) : "r"(val));
}

/* No need to examine error -- sethae never fails.  */
static inline void __sethae(unsigned long value)
{
...
static inline unsigned long int port_to_cpu_addr(unsigned long int port, ioswizzle_t ioswiz, int size)
{
...
static inline void inline_outb(unsigned char b, unsigned long int port, ioswizzle_t ioswiz)
{
    unsigned int w;
...
static inline void inline_outw(unsigned short int b, unsigned long int port, ioswizzle_t ioswiz)
{
    unsigned long w;
...
static inline void inline_outl(unsigned int b, unsigned long int port, ioswizzle_t ioswiz)
{
...
static inline unsigned int inline_inb(unsigned long int port, ioswizzle_t ioswiz)
{
    unsigned long int addr = port_to_cpu_addr(port, ioswiz, 1);
    int result;
...
static inline unsigned int inline_inw(unsigned long int port, ioswizzle_t ioswiz)
{
    unsigned long int addr = port_to_cpu_addr(port, ioswiz, 2);
    int result;
...
static inline unsigned int inline_inl(unsigned long int port, ioswizzle_t ioswiz)
{
    unsigned long int addr = port_to_cpu_addr(port, ioswiz, 4);
...
static inline unsigned long int dense_port_to_cpu_addr(unsigned long int port)
{
    return port + io.base;
}

static inline void inline_bwx_outb(unsigned char b, unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
    stb_mb(b, addr);
}

static inline void inline_bwx_outw(unsigned short int b, unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
    stw_mb(b, addr);
}

static inline void inline_bwx_outl(unsigned int b, unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
    stl_mb(b, addr);
}

static inline unsigned int inline_bwx_inb(unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
    unsigned char r;
...
static inline unsigned int inline_bwx_inw(unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
    unsigned short r;
...
static inline unsigned int inline_bwx_inl(unsigned long int port)
{
    unsigned long int addr = dense_port_to_cpu_addr(port);
...
static inline int process_cpuinfo(struct cpuinfo_data *data)
{
