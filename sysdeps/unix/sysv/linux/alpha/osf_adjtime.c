...
int
attribute_compat_text_section __adjtime_tv32(const struct __timeval32 *itv, struct __timeval32 *otv)
{
...
int
attribute_compat_text_section __adjtimex_tv32(struct timex32 *tx)
{
    struct timex tx64;
