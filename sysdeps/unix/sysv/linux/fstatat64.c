...
static inline int fstatat64_time64_statx(int fd, const char *file, struct __stat64_t64 *buf,
        int flag)
{
...
static inline int fstatat64_time64_stat(int fd, const char *file, struct __stat64_t64 *buf,
                                        int flag)
{
    int r;
...
int __fstatat64_time64(int fd, const char *file, struct __stat64_t64 *buf,
                       int flag)
{
    int r;
