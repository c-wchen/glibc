...
static void set_speeds(int fd, speed_t ospeed, speed_t ispeed)
{
    struct termios tio;
...
static void run_speed_test(int fd, speed_test_t test);

/* New interface cfset*speed test */
static void new_cfspeed_test(int fd, speed_t speed)
{
    struct termios tio;
...
static void new_tcspeed_test(int fd, speed_t speed)
{
    struct termios tio;
    speed_t old_ospeed, old_ispeed;
...
static void new_cfbaud_test(int fd, baud_t baud)
{
    struct termios tio;
...
static void new_tcbaud_test(int fd, baud_t baud)
{
    struct termios tio;
    baud_t old_obaud, old_ibaud;
...
/* Old interface test. This relies on the new struct termios always
   ...
   on the old glibc. */
static void old_tcspeed_test(int fd, speed_t speed)
{
    struct termios tio;
    speed_t cbaud;
...
static void old_invalid_speeds_test(int fd)
{
    struct termios tio;
    speed_t cbaud;
...
static void compat_tests(int fd)
{
...
static void run_speed_tests(int fd)
{
...
static void run_in_chroot(void)
{
