...
_Static_assert(sizeof((struct msqid_ds)
{
    0
} .msg_perm.mode)
== sizeof(mode_t),
...
static void msqid64_to_kmsqid64(const struct __msqid64_ds *msqid64,
...
static void kmsqid64_to_msqid64(const struct kernel_msqid64_ds *kmsqid,
...
static int msgctl_syscall(int msqid, int cmd, msgctl_arg_t *buf)
{
...
int __msgctl64(int msqid, int cmd, struct __msqid64_ds *buf)
{
...
static void msqid64_to_msqid(struct msqid_ds *mq, const struct __msqid64_ds *mq64)
{
...
int
attribute_compat_text_section __msgctl_mode16(int msqid, int cmd, struct msqid_ds *buf)
{
...
int
attribute_compat_text_section __old_msgctl(int msqid, int cmd, struct __old_msqid_ds *buf)
{
