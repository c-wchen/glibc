...
static void maybe_script_execute(struct posix_spawn_args *args)
{
...
static int __spawnix(int *pid, const char *file,
                     ...
                     int (*exec)(const char *, char *const *, char *const *))
{
    ...
    args.attr = attrp ? attrp : &(const posix_spawnattr_t) {
        0
    };
    args.argv = argv;
    args.argc = argc;
