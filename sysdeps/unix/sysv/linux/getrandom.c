...
static inline ssize_t getrandom_syscall(void *buffer, size_t length, unsigned int flags,
                                        bool cancel)
{
    return cancel
...
static bool vgetrandom_get_state_alloc(void)
{
...
static ssize_t getrandom_vdso(void *buffer, size_t length, unsigned int flags, bool cancel)
{
...
void __getrandom_early_init(_Bool initial)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
...
void __getrandom_reset_state(struct pthread *curp)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
...
/* Called when a thread terminates, and adds its random buffer back into the
   ...
   blocked. */
void __getrandom_vdso_release(struct pthread *curp)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
...
void __getrandom_fork_subprocess(void)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
...
ssize_t __getrandom_nocancel(void *buffer, size_t length, unsigned int flags)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
...
ssize_t __getrandom(void *buffer, size_t length, unsigned int flags)
{
#ifdef HAVE_GETRANDOM_VSYSCALL
