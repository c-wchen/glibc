...
static void *notification_function(void *arg)
{
...
void __mq_notify_fork_subprocess(void)
{
    once = PTHREAD_ONCE_INIT;
}


static void init_mq_netlink(void)
{
...
/* Register notification upon message arrival to an empty message queue
   MQDES.  */
int __mq_notify(mqd_t mqdes, const struct sigevent *notification)
{
