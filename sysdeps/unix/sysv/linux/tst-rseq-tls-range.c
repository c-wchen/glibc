...
static void add_range(const char *prefix, const char *label,
...
static int range_compare(const void *a1, const void *b1)
{
...
static void check_for_overlap(void)
{
...
static int dlip_callback(struct dl_phdr_info *info, size_t size, void *ignored)
{
...
static void add_tls_ranges(void)
{
