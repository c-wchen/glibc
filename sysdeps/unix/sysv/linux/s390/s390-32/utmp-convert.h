...
/* Convert the 64 bit struct utmp value in FROM to the 32 bit version
   returned in TO.  */
static inline void utmp_convert64to32(const struct utmp *from, struct utmp32 *to)
{
#if _HAVE_UT_TYPE - 0
...
/* Convert the 32 bit struct utmp value in FROM to the 64 bit version
   returned in TO.  */
static inline void utmp_convert32to64(const struct utmp32 *from, struct utmp *to)
{
#if _HAVE_UT_TYPE - 0
    to->ut_type = from->ut_type;
#endif
