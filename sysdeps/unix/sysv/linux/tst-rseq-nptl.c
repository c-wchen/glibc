...
static void rseq_key_destructor(void *arg)
{
...
static void do_rseq_main_test(void)
{
...
static void test_cancel_thread(void)
{
...
static int do_rseq_threads_test(int nr_threads)
{
...
static void subprocess_callback(void *closure)
{
    do_rseq_main_test();
}

static void do_rseq_fork_test(void)
{
    support_isolate_in_subprocess(subprocess_callback, NULL);
}

static int do_rseq_test(void)
{
