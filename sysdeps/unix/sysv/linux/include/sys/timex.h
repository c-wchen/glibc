...
static inline struct timex valid_timex64_to_timex(const struct __timex64 tx64)
{
    struct timex tx;
...
static inline struct __ntptimeval64 valid_ntptimeval_to_ntptimeval64(const struct ntptimeval ntv)
{
...
static inline struct ntptimeval valid_ntptimeval64_to_ntptimeval(const struct __ntptimeval64 ntp64)
{
