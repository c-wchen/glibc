...
static void *thread_burn_one_cpu(void *closure)
{
...
static void *thread_burn_any_cpu(void *closure)
{
...
static void stop_and_join_threads(struct conf *conf, cpu_set_t *set,
...
static bool early_test(struct conf *conf)
{
