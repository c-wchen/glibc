...
int ___timer_gettime64(timer_t timerid, struct __itimerspec64 *value)
{
...
int __timer_gettime(timer_t timerid, struct itimerspec *value)
{
...
int __timer_gettime_old(int timerid, struct itimerspec *value)
{
