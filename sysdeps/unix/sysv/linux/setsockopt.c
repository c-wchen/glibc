...
static int setsockopt_syscall(int fd, int level, int optname, const void *optval,
                              socklen_t len)
{
...
static int setsockopt32(int fd, int level, int optname, const void *optval,
                        socklen_t len)
{
    int r = -1;
...
int __setsockopt(int fd, int level, int optname, const void *optval, socklen_t len)
{
