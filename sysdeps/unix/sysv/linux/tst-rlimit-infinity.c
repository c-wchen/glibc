...
static void test_getrlimit(int resource, rlim_t exp_cur, rlim_t exp_max)
{
    struct rlimit r;
...
static void test_getrlimit64(int resource, rlim64_t exp_cur, rlim64_t exp_max)
{
    struct rlimit64 r;
...
static void test_prlimit_get(int resource, rlim_t exp_cur, rlim_t exp_max)
{
    struct rlimit r;
...
static void test_prlimit64_get(int resource, rlim64_t exp_cur, rlim64_t exp_max)
{
    struct rlimit64 r;
...
static void test_setrlimit(int resource, rlim_t new_cur, rlim_t new_max)
{
    struct rlimit r = { new_cur, new_max };
    TEST_COMPARE(setrlimit(resource, &r), 0);
}

static void test_setrlimit64(int resource, rlim64_t new_cur, rlim64_t new_max)
{
    struct rlimit64 r = { new_cur, new_max };
    TEST_COMPARE(setrlimit64(resource, &r), 0);
}

static void test_prlimit_set(int resource, rlim_t new_cur, rlim_t new_max)
{
    struct rlimit r = { new_cur, new_max };
    TEST_COMPARE(prlimit(0, resource, &r, NULL), 0);
}

static void test_prlimit64_set(int resource, rlim64_t new_cur, rlim64_t new_max)
{
    struct rlimit64 r = { new_cur, new_max };
