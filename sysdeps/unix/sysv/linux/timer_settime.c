...
int ___timer_settime64(timer_t timerid, int flags,
...
int __timer_settime(timer_t timerid, int flags, const struct itimerspec *value,
...
int __timer_settime_old(int timerid, int flags, const struct itimerspec *value,
                        struct itimerspec *ovalue)
{
