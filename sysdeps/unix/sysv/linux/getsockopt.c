...
static int getsockopt_syscall(int fd, int level, int optname, void *optval,
                              socklen_t *len)
{
...
static int getsockopt32(int fd, int level, int optname, void *optval,
                        socklen_t *len)
{
    int r = -1;
...
int __getsockopt(int fd, int level, int optname, void *optval, socklen_t *len)
{
