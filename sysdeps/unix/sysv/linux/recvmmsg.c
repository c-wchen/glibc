...
static int recvmmsg_syscall(int fd, struct mmsghdr *vmessages, unsigned int vlen,
...
int __recvmmsg64(int fd, struct mmsghdr *vmessages, unsigned int vlen, int flags,
