...
static __always_inline int dl_cet_disable_cet(unsigned int cet_feature)
{
...
static __always_inline int dl_cet_lock_cet(unsigned int cet_feature)
{
    if (cet_feature != GNU_PROPERTY_X86_FEATURE_1_SHSTK) {
        return -1;
    }
...
static __always_inline unsigned int dl_cet_get_cet_status(void)
{
...
static __always_inline bool dl_cet_ibt_enabled(void)
{
