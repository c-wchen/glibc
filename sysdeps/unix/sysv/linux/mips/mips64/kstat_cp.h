...
static inline long int __cp_kstat_stat(const struct kernel_stat *kst, struct stat *st)
{
...
static inline void __cp_kstat_stat64_t64(const struct kernel_stat *kst, struct __stat64_t64 *st)
{
    st->st_dev = kst->st_dev;
    st->st_ino = kst->st_ino;
    st->st_mode = kst->st_mode;
