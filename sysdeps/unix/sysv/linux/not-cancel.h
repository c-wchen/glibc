...
static inline ssize_t __getrandom_nocancel_direct(void *buf, size_t buflen, unsigned int flags)
{
...
static inline int __poll_infinity_nocancel(struct pollfd *fds, nfds_t nfds)
{
