...
static __always_inline unsigned int index_first_eq(op_t x1, op_t x2)
{
...
static __always_inline unsigned int index_first_zero_eq(op_t x1, op_t x2)
{
    unsigned int ret;
...
static __always_inline unsigned int index_first_zero_ne(op_t x1, op_t x2)
{
    unsigned int ret;
...
static __always_inline unsigned int index_last_zero(op_t x)
{
    unsigned int ret;
...
static __always_inline unsigned int index_last_eq(op_t x1, op_t x2)
{
