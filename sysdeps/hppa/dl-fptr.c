...
static struct fdesc_table *new_fdesc_table(struct local *l, size_t *size)
{
...
static inline Elf32_Addr elf_machine_resolve(void)
{
    Elf32_Addr addr;
...
static inline int _dl_read_access_allowed(unsigned int *addr)
{
    int result;
