...
static __always_inline void libc_feholdexcept_s390(fenv_t *envp)
{
...
static __always_inline void libc_fesetround_s390(int round)
{
...
static __always_inline void libc_feholdexcept_setround_s390(fenv_t *envp, int r)
{
    fpu_control_t fpc, fpc_new;
...
static __always_inline int libc_fetestexcept_s390(int excepts)
{
    int res;
    fexcept_t fpc;
...
static __always_inline void libc_fesetenv_s390(const fenv_t *envp)
{
...
static __always_inline int libc_feupdateenv_test_s390(const fenv_t *envp, int ex)
{
...
static __always_inline void libc_feupdateenv_s390(const fenv_t *envp)
{
...
static __always_inline fenv_t libc_handle_user_fenv_s390(const fenv_t *envp)
{
    fenv_t env;
    if (envp == FE_DFL_ENV) {
...
static __always_inline void libc_feholdsetround_s390_ctx(struct rm_ctx *ctx, int r)
{
    fpu_control_t fpc;
    int round;
...
static __always_inline void libc_feresetround_s390_ctx(struct rm_ctx *ctx)
{
...
static __always_inline void libc_feholdsetround_noex_s390_ctx(struct rm_ctx *ctx, int r)
{
...
static __always_inline void libc_feresetround_noex_s390_ctx(struct rm_ctx *ctx)
{
