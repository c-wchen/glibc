...
static const unsigned char table_iso8859_1_to_cp037[256] __attribute__((aligned(8))) = {
...
static const unsigned char table_cp037_iso8859_1[256] __attribute__((aligned(8))) = {
    [0x00] = 0x00, [0x01] = 0x01, [0x02] = 0x02, [0x03] = 0x03,
