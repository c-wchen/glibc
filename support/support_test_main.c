...
static void print_timestamp(const char *what, struct timespec tv)
{
    struct tm tm;
...
static int run_test_function(int argc, char **argv, const struct test_config *config)
{
...
static int adjust_exit_status(int status)
{
...
int support_test_main(int argc, char **argv, const struct test_config *config)
{
    if (test_main_called) {
