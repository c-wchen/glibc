...
static struct support_subprocess support_subprocess_init(void)
{
...
int support_subprogram_wait(const char *file, char *const argv[])
{
    posix_spawn_file_actions_t fa;
...
static bool support_process_kill(int pid, int signo, int *status)
{
