...
static void report_length(const char *what, const CHAR *str, size_t length)
{
    if (str == NULL) {
...
static void report_string(const char *what, const UCHAR *blob,
...
static size_t string_length_or_zero(const CHAR *str)
{
    if (str == NULL) {
        return 0;
    } else {
