...
static void add_temp_file_internal(const char *name, bool toolong)
{
...
int create_temp_file_in_dir(const char *base, const char *dir, char **filename)
{
    char *fname;
    int fd;
...
static char *create_temp_directory_internal(const char *base, bool toolong)
{
...
static void ensure_toolong_initialized(void)
{
...
static void initialize_toolong(const char *base)
{
...
static void remove_toolong_subdirs(const char *base)
{
    ensure_toolong_initialized();
...
void support_delete_temp_files(void)
{
    pid_t pid = getpid();
...
void support_print_temp_files(FILE *f)
{
...
void support_set_test_dir(const char *path)
{
    test_dir = path;
}
