...
static void print_context(const char *context, bool *failed)
{
    if (*failed)
...
static void print_actual_status(struct support_capture_subprocess *proc)
{
...
void support_capture_subprocess_check(struct support_capture_subprocess *proc,
