...
static int test_mmee(int mode1, int mode2, int exc1, int exc2)
{
    int result = 0;
...
static int test_mme(int mode1, int mode2, int exc1)
{
    int result = 0;
...
static int test_mm(int mode1, int mode2)
{
    int result = 0;
