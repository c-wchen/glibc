...
static void assert_exact(int i)
{
    assert(i == 0);
}
...
static generic_value_type generic_arg_ret_type(arg_ret_type t)
{
    switch (t) {
        case type_fp:
            return gtype_fp;
...
static void generic_value_free(generic_value *v)
{
    switch (v->type) {
        case gtype_fp:
...
static void generic_value_copy(generic_value *dest, const generic_value *src)
{
    dest->type = src->type;
    switch (src->type) {
        case gtype_fp:
...
static void init_fp_formats(void)
{
...
static size_t special_fill_max(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                               fp_format format)
{
...
static size_t special_fill_minus_max(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                                     fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_min(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                               fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_minus_min(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                                     fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_min_subnorm(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                                       fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_minus_min_subnorm(mpfr_t res0,
...
static size_t special_fill_min_subnorm_p120(mpfr_t res0,
        mpfr_t res1 __attribute__((unused)),
        fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_pi(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_minus_pi(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_const_pi(res0, MPFR_RNDU);
...
static size_t special_fill_pi_2(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_const_pi(res0, MPFR_RNDU);
...
static size_t special_fill_minus_pi_2(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_const_pi(res0, MPFR_RNDU);
    assert_exact(mpfr_div_ui(res0, res0, 2, MPFR_RNDN));
...
static size_t special_fill_pi_4(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_pi_6(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
...
static size_t special_fill_minus_pi_6(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si_2exp(res0, -1, -1, MPFR_RNDN));
    mpfr_asin(res0, res0, MPFR_RNDU);
...
static size_t special_fill_pi_3(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si_2exp(res0, 1, -1, MPFR_RNDN));
...
static size_t special_fill_2pi_3(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si_2exp(res0, -1, -1, MPFR_RNDN));
    mpfr_acos(res0, res0, MPFR_RNDU);
...
static size_t special_fill_2pi(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_const_pi(res0, MPFR_RNDU);
...
static size_t special_fill_e(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si(res0, 1, MPFR_RNDN));
...
static size_t special_fill_1_e(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si(res0, -1, MPFR_RNDN));
    mpfr_exp(res0, res0, MPFR_RNDU);
...
static size_t special_fill_e_minus_1(mpfr_t res0, mpfr_t res1, fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    assert_exact(mpfr_set_si(res0, 1, MPFR_RNDN));
...
/* Set the precision of RES0 based on FORMAT and initialize as an
   infinite number.  */
static size_t special_fill_inf(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                               fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_set_inf(res0, 0);
...
static size_t special_fill_minus_inf(mpfr_t res0, mpfr_t res1 __attribute__((unused)),
                                     fp_format format)
{
    mpfr_init2(res0, fp_formats[format].mant_dig);
    mpfr_set_inf(res0, -1);
...
static void adjust_real(mpfr_t r, bool inexact)
{
    if (!inexact) {
        return;
    }
...
static void round_real(mpfr_t res[rm_num_modes],
...
static void handle_input_arg(const char *arg, input_test *it, size_t num_prev_args,
...
static void handle_input_flag(char *arg, input_flag *flag,
                              const char *filename, unsigned int lineno)
{
    char *ep = strchr(arg, ':');
    if (ep == NULL) {
...
static void add_test(char *line, const char *filename, unsigned int lineno)
{
    size_t num_tokens = 1;
    char *p = line;
...
static void calc_generic_results(generic_value *outputs, generic_value *inputs,
...
static int int_type_bits(arg_ret_type type, int long_bits)
{
...
static bool int_fits_type(mpz_t z, arg_ret_type type, int long_bits)
{
...
static void output_generic_value(FILE *fp, const char *filename, const generic_value *v,
...
static void output_for_one_input_case(FILE *fp, const char *filename, test_function *tf,
...
static void generate_output(const char *function, bool narrow, const char *filename)
{
