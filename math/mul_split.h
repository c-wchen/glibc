...
static void mul_split(double *hi, double *lo, double x, double y)
{
#ifdef __FP_FAST_FMA
...
static inline void mul_expansion(double *hi, double *lo, double h1, double l1,
                                 double h2, double l2)
{
    double r, e;
...
static inline void div_split(double *hi, double *lo, double x, double y)
{
    double a, b;
...
static inline void div_expansion(double *hi, double *lo, double h1, double l1,
                                 double h2, double l2)
{
    double r, e;
