...
static void test_single_exception(short int exception,
                                  short int exc_flag,
                                  fexcept_t fe_flag,
...
static void test_exceptions(const char *test_name, short int exception,
                            int ignore_inexact)
{
    printf("Test: %s\n", test_name);
#ifdef FE_DIVBYZERO
...
static void print_rounding(int rounding)
{
...
static void test_rounding(const char *test_name, int rounding_mode)
{
...
#if FE_ALL_EXCEPT
static void set_single_exc(const char *test_name, int fe_exc, fexcept_t exception)
{
    char str[200];
...
static void update_single_exc(const char *test_name, const fenv_t *envp, int fe_exc,
...
#if FE_ALL_EXCEPT
static const char *funcname(int (*func)(const fenv_t *))
{
    if (func == fesetenv) {
        return "fesetenv";
...
static void feenv_nomask_test(const char *flag_name, int fe_exc, int (*func)(const fenv_t *))
{
...
static void feenv_mask_test(const char *flag_name, int fe_exc, int (*func)(const fenv_t *))
{
    int status;
    pid_t pid;
...
/* Test that program aborts with no masked interrupts */
static void feexcp_nomask_test(const char *flag_name, int fe_exc)
{
    int status;
    pid_t pid;
...
static void feexcp_mask_test(const char *flag_name, int fe_exc)
{
    int status;
    int exception;
    pid_t pid;
...
static void feenable_test(const char *flag_name, int fe_exc)
{
    int excepts;
...
static void fe_single_test(const char *flag_name, int fe_exc)
{
...
static void feupdate_single_test(const char *flag_name, int fe_exc)
{
...
#if FE_ALL_EXCEPT
static void feupdateenv_single_test(const char *test_name, int fe_exc, int exception)
{
    char str[100];
    fenv_t env;
    int res;
...
static void feupdateenv_tests(void)
{
    /* We might have some exceptions still set.  */
    feclearexcept(FE_ALL_EXCEPT);
...
static void feholdexcept_tests(void)
{
    fenv_t saved, saved2;
    int res;
...
static void initial_tests(void)
{
