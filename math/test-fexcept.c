...
static int feraiseexcept_exact(int exc)
{
#ifdef FE_INEXACT
    int mask = 0;
#ifdef FE_OVERFLOW
...
static int test_set(int initial, const fexcept_t *saved, int mask, int expected)
{
    int result = 0;
...
static int test_except(int exc, const char *exc_name)
{
    int result = 0;
