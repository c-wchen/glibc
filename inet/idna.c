...
static void *functions_allocate(void *closure)
{
...
static void functions_deallocate(void *closure, void *ptr)
{
...
static inline struct functions *get_functions(void)
{
...
static int gai_strdup(const char *name, char **result)
{
