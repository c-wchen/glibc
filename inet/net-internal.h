...
static inline bool __deadline_is_infinite(struct deadline deadline)
{
...
static inline bool __deadline_elapsed(struct deadline_current_time current,
...
static inline struct deadline __deadline_first(struct deadline left, struct deadline right)
{
...
/* Return true if TV.tv_sec is non-negative and TV.tv_usec is in the
   interval [0, 999999].  */
static inline bool __is_timeval_valid_timeout(struct timeval tv)
{
