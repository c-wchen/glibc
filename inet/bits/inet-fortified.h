...
__fortify_function __attribute_overloadable__ const char *__NTH(inet_ntop(int __af,
...
__fortify_function __attribute_overloadable__ int __NTH(inet_pton(int __af,
