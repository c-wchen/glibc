...
static void yp_bind_client_create(const char *domain, dom_binding *ysd,
...
#if USE_BINDINGDIR
static void yp_bind_file(const char *domain, dom_binding *ysd)
{
...
static int do_ypcall(const char *domain, u_long prog, xdrproc_t xargs,
...
static int do_ypcall_tr(const char *domain, u_long prog, xdrproc_t xargs,
                        caddr_t req, xdrproc_t xres, caddr_t resp)
{
...
int yp_all(const char *indomain, const char *inmap,
