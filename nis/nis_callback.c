...
static void cb_prog_1(struct svc_req *rqstp, SVCXPRT *transp)
{
    union {
...
static nis_error internal_nis_do_callback(struct dir_binding *bptr, netobj *cookie,
        struct nis_cb *cb)
{
...
nis_error __nis_do_callback(struct dir_binding *bptr, netobj *cookie,
                            struct nis_cb *cb)
{
    nis_error result;
