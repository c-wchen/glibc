...
static char *basic_strstr(const char *s1, const char *s2)
{
    size_t i;
    int c = s2[0];
...
static char *twoway_strstr(const char *haystack, const char *needle)
{
...
static void do_test(json_ctx_t *json_ctx, size_t align1, size_t align2, size_t len1,
...
static void test_hard_needle(json_ctx_t *json_ctx, size_t ne_len, size_t hs_len)
{
    char *ne = (char *) buf1;
    char *hs = (char *) buf2;
