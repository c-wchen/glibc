...
static timing_t test_mutex(long iters, int filler)
{
...
static timing_t test_mutex_trylock(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_rwlock_read(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_rwlock_tryread(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_rwlock_write(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_rwlock_trywrite(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_spin_lock(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_spin_trylock(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_sem_wait(long iters, int filler)
{
    timing_t start, stop, cur;
...
static timing_t test_sem_trywait(long iters, int filler)
{
    timing_t start, stop, cur;
...
static void *test_condvar_helper(void *v)
{
...
static timing_t test_condvar(long iters, int filler)
{
    timing_t start, stop, cur;
    pthread_t helper_id;
...
static timing_t test_consumer_producer(long iters, int filler)
{
    timing_t start, stop, cur;
    pthread_t helper_id;
    Producer_Params p;
...
static int do_bench_2(const char *name, test_t func, int filler, json_ctx_t *js)
{
    timing_t cur;
...
static int do_bench_1(const char *name, test_t func, json_ctx_t *js)
{
    int rv = 0;
