...
int generic_strncmp(const char *s1, const char *s2, size_t n);
...
static void do_test_limit(json_ctx_t *json_ctx, size_t align1, size_t align2, size_t len,
...
static void do_test(json_ctx_t *json_ctx, size_t align1, size_t align2, size_t len, size_t
...
static void do_one_test_page_boundary(json_ctx_t *json_ctx, CHAR *s1, CHAR *s2,
...
static void do_test_page_boundary(json_ctx_t *json_ctx)
{
...
static void do_one_test_page(json_ctx_t *json_ctx, size_t offset1, size_t offset2,
                             CHAR *s2)
{
    CHAR *s1;
    int exp_result;
...
static void do_test_page(json_ctx_t *json_ctx)
{
    size_t i;
    CHAR *s1, *s2;
