...
static size_t count_words(const char *text, const char *delim)
{
    size_t wordcount = 0;
...
static word_list *new_word_list(size_t size)
{
...
static word_list *str_word_list(const char *str, const char *delim)
{
    size_t n = 0;
...
static word_list *copy_word_list(const word_list *list)
{
    size_t i;
...
static void bench_list(json_ctx_t *json_ctx, word_list *list)
{
    size_t i;
...
static result_t bench_file(json_ctx_t *json_ctx, const char *testname, const char *filename,
                           const char *locale)
{
