...
static void init_memset_distribution(void)
{
    int i, j, freq, size, n;
...
static void do_one_test(json_ctx_t *json_ctx, impl_t *impl, size_t iters,
...
static void do_test(json_ctx_t *json_ctx, size_t max_size)
{
    int n;
