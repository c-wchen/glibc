...
void *generic_memccpy(void *dst, const void *src, int c, size_t n)
{
...
static void do_one_test(impl_t *impl, void *dst, const void *src, int c, size_t len,
                        size_t n)
{
...
static void do_test(size_t align1, size_t align2, int c, size_t len, size_t n,
                    int max_char)
{
    size_t i;
    char *s1, *s2;
