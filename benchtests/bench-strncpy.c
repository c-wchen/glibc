...
CHAR *generic_strncpy(CHAR *dst, const CHAR *src, size_t n)
{
...
static void do_one_test(json_ctx_t *json_ctx, impl_t *impl, CHAR *dst, const CHAR *src,
                        size_t len, size_t n)
{
...
static void do_test(json_ctx_t *json_ctx, size_t align1, size_t align2, size_t len,
