...
static unsigned int get_random_block_size(unsigned int *state)
{
...
static unsigned int get_random_offset(unsigned int *state)
{
    unsigned int idx = *state;
...
static size_t malloc_benchmark_loop(void **ptr_arr)
{
...
static timing_t do_benchmark(size_t num_threads, size_t *iters)
{
    timing_t elapsed = 0;
