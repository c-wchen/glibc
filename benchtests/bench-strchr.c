...
static void __attribute_optimization_barrier__ do_one_rand_test(json_ctx_t *json_ctx, impl_t *impl, const CHAR *s,
        const CHAR *c)
{
    size_t i, iters = INNER_LOOP_ITERS8;
    timing_t start, stop, cur;
...
static void do_rand_test(json_ctx_t *json_ctx, size_t align, size_t pos, size_t len,
                         float perc_zero)
{
    size_t i;
    int perc_zero_int;
...
static void do_one_test(json_ctx_t *json_ctx, impl_t *impl, const CHAR *s, int c,
                        const CHAR *exp_res)
{
    size_t i, iters = INNER_LOOP_ITERS8;
    timing_t start, stop, cur;
...
static void do_test(json_ctx_t *json_ctx, size_t align, size_t pos, size_t len,
