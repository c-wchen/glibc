...
void *basic_memmem(const void *haystack, size_t hs_len, const void *needle,
                   size_t ne_len)
{
...
void *twoway_memmem(const void *haystack_start, size_t haystack_len,
...
static void do_test(json_ctx_t *json_ctx, const char *str, size_t len, size_t idx)
{
    char tmpbuf[len];
...
static void do_random_tests(json_ctx_t *json_ctx)
{
