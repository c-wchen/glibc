...
static int sort_he(const void *p1, const void *p2)
{
...
static int sort_he_data(const void *p1, const void *p2)
{
    struct hashentry *h1 = *(struct hashentry **) p1;
    struct hashentry *h2 = *(struct hashentry **) p2;
...
static void markrange(BITMAP_T *mark, ref_t start, size_t len)
{
...
void *mempool_alloc(struct database_dyn *db, size_t len, int data_alloc)
{
