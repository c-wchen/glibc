...
static time_t cache_addgr(struct database_dyn *db, int fd, request_header *req,
...
static int lookup(int type, union keytype key, struct group *resultbufp, char *buffer,
...
static time_t addgrbyX(struct database_dyn *db, int fd, request_header *req,
...
void addgrbyname(struct database_dyn *db, int fd, request_header *req,
                 void *key, uid_t uid)
{
...
time_t readdgrbyname(struct database_dyn *db, struct hashentry *he,
                     struct datahead *dh)
{
    request_header req = {
        .type = GETGRBYNAME,
...
void addgrbygid(struct database_dyn *db, int fd, request_header *req,
                void *key, uid_t uid)
{
    char *ep;
...
time_t readdgrbygid(struct database_dyn *db, struct hashentry *he,
                    struct datahead *dh)
{
    char *ep;
