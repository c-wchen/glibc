...
static time_t cache_addpw(struct database_dyn *db, int fd, request_header *req,
...
static int lookup(int type, union keytype key, struct passwd *resultbufp, char *buffer,
...
static time_t addpwbyX(struct database_dyn *db, int fd, request_header *req,
...
void addpwbyname(struct database_dyn *db, int fd, request_header *req,
...
time_t readdpwbyname(struct database_dyn *db, struct hashentry *he,
                     struct datahead *dh)
{
    request_header req = {
        .type = GETPWBYNAME,
...
void addpwbyuid(struct database_dyn *db, int fd, request_header *req,
                void *key, uid_t c_uid)
{
    char *ep;
...
time_t readdpwbyuid(struct database_dyn *db, struct hashentry *he,
                    struct datahead *dh)
{
    char *ep;
