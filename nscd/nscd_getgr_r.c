...
int __nscd_getgrnam_r(const char *name, struct group *resultbuf, char *buffer,
                      size_t buflen, struct group **result)
{
...
int __nscd_getgrgid_r(gid_t gid, struct group *resultbuf, char *buffer,
                      size_t buflen, struct group **result)
{
...
/* Note that we only free the structure if necessary.  The memory
   ...
   handling.  */
void __nscd_gr_map_freemem(void)
{
