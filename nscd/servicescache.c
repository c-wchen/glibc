...
static time_t cache_addserv(struct database_dyn *db, int fd, request_header *req,
...
static int lookup(int type, char *key, struct servent *resultbufp, char *buffer,
...
static time_t addservbyX(struct database_dyn *db, int fd, request_header *req,
...
void addservbyname(struct database_dyn *db, int fd, request_header *req,
                   void *key, uid_t uid)
{
...
time_t readdservbyname(struct database_dyn *db, struct hashentry *he,
                       struct datahead *dh)
{
    request_header req = {
        .type = GETSERVBYNAME,
...
void addservbyport(struct database_dyn *db, int fd, request_header *req,
                   void *key, uid_t uid)
{
    addservbyX(db, fd, req, key, uid, NULL, NULL);
}
...
time_t readdservbyport(struct database_dyn *db, struct hashentry *he,
                       struct datahead *dh)
{
    request_header req = {
        .type = GETSERVBYPORT,
