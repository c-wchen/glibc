...
static inline time_t datahead_init_common(struct datahead *head, nscd_ssize_t allocsize,
...
static inline time_t datahead_init_pos(struct datahead *head, nscd_ssize_t allocsize,
...
static inline time_t datahead_init_neg(struct datahead *head, nscd_ssize_t allocsize,
                                       nscd_ssize_t recsize, uint32_t ttl)
{
    time_t ret = datahead_init_common(head, allocsize, recsize, ttl);
