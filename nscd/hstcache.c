...
static time_t cache_addhst(struct database_dyn *db, int fd, request_header *req,
...
static int lookup(int type, void *key, struct hostent *resultbufp, char *buffer,
...
static time_t addhstbyX(struct database_dyn *db, int fd, request_header *req,
...
void addhstbyname(struct database_dyn *db, int fd, request_header *req,
                  void *key, uid_t uid)
{
...
time_t readdhstbyname(struct database_dyn *db, struct hashentry *he,
                      struct datahead *dh)
{
    request_header req = {
        .type = GETHOSTBYNAME,
...
void addhstbyaddr(struct database_dyn *db, int fd, request_header *req,
                  void *key, uid_t uid)
{
    addhstbyX(db, fd, req, key, uid, NULL, NULL);
}
...
time_t readdhstbyaddr(struct database_dyn *db, struct hashentry *he,
                      struct datahead *dh)
{
    request_header req = {
        .type = GETHOSTBYADDR,
...
void addhstbynamev6(struct database_dyn *db, int fd, request_header *req,
                    void *key, uid_t uid)
{
    addhstbyX(db, fd, req, key, uid, NULL, NULL);
}
...
time_t readdhstbynamev6(struct database_dyn *db, struct hashentry *he,
                        struct datahead *dh)
{
    request_header req = {
...
void addhstbyaddrv6(struct database_dyn *db, int fd, request_header *req,
                    void *key, uid_t uid)
{
    addhstbyX(db, fd, req, key, uid, NULL, NULL);
}
...
time_t readdhstbyaddrv6(struct database_dyn *db, struct hashentry *he,
                        struct datahead *dh)
{
    request_header req = {
