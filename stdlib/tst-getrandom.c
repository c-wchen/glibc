...
/* Test getrandom with a single buffer length.  NB: The passed-in
   ...
   unchanged.  */
static void test_length(char *buffer, size_t length, unsigned int flags)
{
...
static bool getrandom_full(char *buffer, size_t length, unsigned int flags)
{
...
static void test_flags(unsigned int flags)
{
