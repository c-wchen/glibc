...
static void init_loc(const char *global_name, const char *local_name)
{
...
static void test_one(const char *format, double value, const char *ldformat,
...
static void test_pair(const struct testcase_pair *pair)
{
...
static void test_en_us(const char *other_name)
{
