...
static void find_stuck_bytes(bool (*func)(unsigned char *key))
{
...
static bool generate_arc4random(unsigned char *key)
{
...
static bool generate_arc4random_buf(unsigned char *key)
{
...
static bool generate_arc4random_uniform(unsigned char *key)
{
...
static bool generate_arc4random_uniform_257(unsigned char *key)
{
    for (int i = 0; i < arc4random_key_size; ++i) {
