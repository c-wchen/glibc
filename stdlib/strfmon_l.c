...
static void __vstrfmon_l_buffer(struct __printf_buffer *buf, locale_t loc,
...
#define right_paren ')'
        ...
        } else if (sign_posn != 0 && sign_posn != 2 && sign_posn != 3
...
ssize_t __vstrfmon_l_internal(char *s, size_t maxsize, locale_t loc,
...
ssize_t ___strfmon_l(char *s, size_t maxsize, locale_t loc, const char *format, ...)
{
    va_list ap;
