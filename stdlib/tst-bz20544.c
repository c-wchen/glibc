...
static void test_bz20544_atexit(void *closure)
{
    atexit_alias(NULL);   /* Should assert.  */
    exit(EXIT_FAILURE);
}

static void test_bz20544_at_quick_exit(void *closure)
{
    at_quick_exit_alias(NULL);   /* Should assert.  */
    exit(EXIT_FAILURE);
}

static void test_bz20544_on_exit(void *closure)
{
    on_exit_alias(NULL, NULL);   /* Should assert.  */
    exit(EXIT_FAILURE);
}

static void test_bz20544_cxa_atexit(void *closure)
{
    __cxa_atexit(NULL, NULL, NULL);   /* Should assert.  */
    exit(EXIT_FAILURE);
}

static void test_bz20544_cxa_at_quick_exit(void *closure)
{
    __cxa_at_quick_exit(NULL, NULL, NULL);   /* Should assert.  */
    exit(EXIT_FAILURE);
}

static void test_one_fn(void (*test_fn)(void *))
{
