...
__fortify_function __attribute_overloadable__ int __NTH(ptsname_r(int __fd,
...
__fortify_function __attribute_overloadable__ __wur int __NTH(wctomb(__fortify_clang_overload_arg(char *,, __s),
        wchar_t __wchar))
{
...
__fortify_function __attribute_overloadable__ size_t __NTH(mbstowcs(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dst),
        const char *__restrict __src,
        size_t __len))
...
__fortify_function __attribute_overloadable__ size_t __NTH(wcstombs(__fortify_clang_overload_arg(char *, __restrict,
        __dst),
        const wchar_t *__restrict __src,
        size_t __len))
{
