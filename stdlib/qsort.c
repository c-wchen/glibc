...
static inline void swap_words_64(void *restrict a, void *restrict b, size_t n)
{
    do {
        n -= 8;
...
static inline void swap_words_32(void *restrict a, void *restrict b, size_t n)
{
    do {
        n -= 4;
...
static inline void siftdown(void *base, size_t size, size_t k, size_t n,
...
static inline void heapify(void *base, size_t size, size_t n, enum swap_type_t swap_type,
...
/* A non-recursive heapsort with worst-case performance of O(nlog n) and
   ...
   elements.  */
static void heapsort_r(void *base, size_t n, size_t size, __compar_d_fn_t cmp, void *arg)
{
    if (n == 0) {
        return;
    }
...
static void
__attribute_used__ indirect_msort_with_tmp(const struct msort_param *p, void *b, size_t n,
        size_t s)
{
    /* Indirect sorting.  */
    char *ip = (char *) b;
...
static void qsort_r_mergesort(void *const pbase, size_t total_elems, size_t size,
...
static bool qsort_r_malloc(void *const pbase, size_t total_elems, size_t size,
...
void __qsort_r(void *const pbase, size_t total_elems, size_t size,
               __compar_d_fn_t cmp, void *arg)
{
    if (total_elems <= 1) {
        return;
