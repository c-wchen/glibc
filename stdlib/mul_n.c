...
void impn_mul_n_basecase(mp_ptr prodp, mp_srcptr up, mp_srcptr vp, mp_size_t size)
{
    mp_size_t i;
    mp_limb_t cy_limb;
    mp_limb_t v_limb;
...
void impn_sqr_n_basecase(mp_ptr prodp, mp_srcptr up, mp_size_t size)
{
    mp_size_t i;
    mp_limb_t cy_limb;
    mp_limb_t v_limb;
...
void mpn_mul_n(mp_ptr prodp, mp_srcptr up, mp_srcptr vp, mp_size_t size)
{
    TMP_DECL(marker);
    TMP_MARK(marker);
    if (up == vp) {
