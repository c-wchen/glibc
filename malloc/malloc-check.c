...
static unsigned char magicbyte(const void *p)
{
    unsigned char magic;
...
/* Visualize the chunk as being partitioned into blocks of 255 bytes from the
   ...
   corruption.  */
static size_t malloc_check_get_size(void *mem)
{
    size_t size;
    unsigned char c;
...
static void *mem2mem_check(void *ptr, size_t req_sz)
{
    mchunkptr p;
...
static mchunkptr mem2chunk_check(void *mem, unsigned char **magic_p)
{
    mchunkptr p;
...
static void free_check(void *mem)
{
    mchunkptr p;
...
static bool initialize_malloc_check(void)
{
