...
static __always_inline bool __is_malloc_debug_enabled(enum malloc_debug_hooks flag)
{
    return __malloc_debugging_hooks & flag;
}

static __always_inline void __malloc_debug_enable(enum malloc_debug_hooks flag)
{
    __malloc_debugging_hooks |= flag;
}

static __always_inline void __malloc_debug_disable(enum malloc_debug_hooks flag)
{
    __malloc_debugging_hooks &= ~flag;
}
...
static void generic_hook_ini(void)
{
    debug_initialized = 0;
    __malloc_hook = NULL;
    __realloc_hook = NULL;
...
static void *memalign_hook_ini(size_t alignment, size_t sz, const void *caller)
{
    generic_hook_ini();
...
static void *__debug_malloc(size_t bytes)
{
...
static void *__debug_memalign(size_t alignment, size_t bytes)
{
...
int malloc_set_state(void *msptr)
{
