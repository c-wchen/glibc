...
static void free_mtrace(void *ptr, const void *caller)
{
    if (ptr == NULL) {
        return;
    }
...
static void malloc_mtrace_after(void *block, size_t size, const void *caller)
{
    Dl_info mem;
    Dl_info *info = lock_and_info(caller, &mem);
...
static void realloc_mtrace_after(void *block, const void *oldptr, size_t size,
                                 const void *caller)
{
    Dl_info mem;
    Dl_info *info = lock_and_info(caller, &mem);
...
static void memalign_mtrace_after(void *block, size_t size, const void *caller)
{
    Dl_info mem;
    Dl_info *info = lock_and_info(caller, &mem);
