...
static void *
__attribute_optimization_barrier__ allocate_zeroed(size_t a, size_t b)
{
    return calloc(a, b);
}
...
/* Call the allocation function specified by allocation_function, with
   ...
   alignment check.  */
static struct allocate_result allocate_1(void)
{
...
static void *allocate_thread(void *closure)
{
...
/* Run all applicable allocation functions for the current test
   parameters.  */
static void run_allocation_functions(void)
{
