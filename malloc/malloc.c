...
static __always_inline void *tag_region(void *ptr, size_t size)
{
...
static __always_inline void *tag_new_zero_region(void *ptr, size_t size)
{
    if (__glibc_unlikely(mtag_enabled)) {
...
static __always_inline void *tag_at(void *ptr)
{
    if (__glibc_unlikely(mtag_enabled)) {
...
static __always_inline size_t checked_request2size(size_t req) __nonnull(1)
{
...
static __always_inline void *tag_new_usable(void *ptr)
{
...
static void *sysmalloc_mmap(INTERNAL_SIZE_T nb, size_t pagesize, int extra_flags, mstate av)
{
    long int size;
...
/*
   ...
   if MORECORE fails.
 */
static void *sysmalloc_mmap_fallback(long int *s, INTERNAL_SIZE_T nb,
...
static __always_inline size_t large_csize2tidx(size_t nb)
{
...
/* Caller must ensure that we know tc_idx is valid and there's room
   for more chunks.  */
static __always_inline void tcache_put_n(mchunkptr chunk, size_t tc_idx, tcache_entry **ep, bool mangled)
{
...
/* Caller must ensure that we know tc_idx is valid and there's
   ...
   list.  */
static __always_inline void *tcache_get_n(size_t tc_idx, tcache_entry **ep, bool mangled)
{
    tcache_entry *e;
    if (!mangled) {
        e = *ep;
...
static __always_inline tcache_entry **tcache_location_large(size_t nb, size_t tc_idx, bool *mangled)
{
...
static __always_inline void tcache_put_large(mchunkptr chunk, size_t tc_idx)
{
    tcache_entry **entry;
    bool mangled = false;
...
static __always_inline void *tcache_get_large(size_t tc_idx, size_t nb)
{
    tcache_entry **entry;
    bool mangled = false;
...
static __always_inline void *tcache_get_align(size_t nb, size_t alignment)
{
...
static void *__attribute_noinline__ tcache_calloc_init(size_t bytes)
{
    tcache_init();
    return __libc_calloc2(bytes);
}

static void *__attribute_noinline__ tcache_malloc_init(size_t bytes)
{
    tcache_init();
...
static void *__attribute_noinline__ __libc_malloc2(size_t bytes)
{
    mstate ar_ptr;
    void *victim;
...
static void *__attribute_noinline__ __libc_calloc2(size_t sz)
{
    mstate av;
    mchunkptr oldtop, p;
...
/* Free chunk P of SIZE bytes to the arena.  HAVE_LOCK indicates where
   ...
   and size are valid.  */
static void _int_free_chunk(mstate av, mchunkptr p, INTERNAL_SIZE_T size, int have_lock)
{
...
static void _int_free_merge_chunk(mstate av, mchunkptr p, INTERNAL_SIZE_T size)
{
...
/* Create a chunk at P of SIZE bytes, with SIZE potentially increased
   ...
   of the new chunk.  */
static INTERNAL_SIZE_T _int_free_create_chunk(mstate av, mchunkptr p, INTERNAL_SIZE_T size,
...
static void _int_free_maybe_consolidate(mstate av, INTERNAL_SIZE_T size)
{
...
static void *_int_realloc(mstate av, mchunkptr oldp, INTERNAL_SIZE_T oldsize,
                          INTERNAL_SIZE_T nb)
{
...
/*
   ------------------------------ mallopt ------------------------------
 */
static __always_inline int do_set_trim_threshold(size_t value)
{
...
static __always_inline int do_set_top_pad(size_t value)
{
...
static __always_inline int do_set_mmap_threshold(size_t value)
{
...
static __always_inline int do_set_mmaps_max(int32_t value)
{
...
static __always_inline int do_set_mallopt_check(int32_t value)
{
    return 1;
}

static __always_inline int do_set_perturb_byte(int32_t value)
{
...
static __always_inline int do_set_arena_test(size_t value)
{
...
static __always_inline int do_set_arena_max(size_t value)
{
...
#if USE_TCACHE
static __always_inline int do_set_tcache_max(size_t value)
{
...
static __always_inline int do_set_tcache_count(size_t value)
{
...
static __always_inline int do_set_tcache_unsorted_limit(size_t value)
{
...
static __always_inline int do_set_hugetlb(size_t value)
{
    if (value == 1) {
...
static __attribute_noinline__ void malloc_printerr_tail(const char *str)
{
