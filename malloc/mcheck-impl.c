...
static void flood(void *ptr, int val, size_t size)
{
    char *cp = ptr;
    while (size--) {
        *cp++ = val;
...
static void *free_mcheck(void *ptr)
{
    if (pedantic) {
...
static bool malloc_mcheck_before(size_t *sizep, void **victimp)
{
    size_t size = *sizep;
...
static void *malloc_mcheck_after(void *mem, size_t size)
{
    struct hdr *hdr = mem;
...
static bool memalign_mcheck_before(size_t alignment, size_t *sizep, void **victimp)
{
    struct hdr *hdr;
...
static void *memalign_mcheck_after(void *block, size_t alignment, size_t size)
{
    if (block == NULL) {
        return NULL;
    }
...
static bool realloc_mcheck_before(void **ptrp, size_t *sizep, size_t *oldsize,
                                  void **victimp)
{
    size_t size = *sizep;
    void *ptr = *ptrp;
...
static void *realloc_mcheck_after(void *ptr, void *oldptr, size_t size, size_t osize)
{
    struct hdr *hdr = ptr;
...
static int mcheck_usable_size(struct hdr *h)
{
    return (h - 1)->size;
}
