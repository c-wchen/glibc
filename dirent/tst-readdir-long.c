...
static char *name_of_length(size_t length)
{
...
static uint64_t add_directory_entry(struct support_fuse_dirstream *d, uint64_t offset)
{
...
static void fuse_thread(struct support_fuse *f, void *closure)
{
...
static void run_readdir_tests(struct support_fuse *f, enum support_readdir_op op)
{
...
static void run_fully_buffered_and_singleton_buffers(struct support_fuse *f)
{
