...
static char *name_at_offset(unsigned int offset)
{
...
static void verify_directory(DIR *dir, enum support_readdir_op op)
{
...
static void rewind_after(unsigned int rewind_at)
{
