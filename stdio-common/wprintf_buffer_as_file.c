...
static void __wprintf_buffer_as_file_commit(struct __wprintf_buffer_as_file *file)
{
...
/* Pointer the FILE * write buffer into the active struct __wprintf_buffer
   area.  */
static void __wprintf_buffer_as_file_switch_to_buffer(struct __wprintf_buffer_as_file *file)
{
...
wint_t __wprintf_buffer_as_file_overflow(FILE *fp, int ch)
{
...
size_t __wprintf_buffer_as_file_xsputn(FILE *fp, const void *buf, size_t len)
{
    struct __wprintf_buffer_as_file *file
        = (struct __wprintf_buffer_as_file *) fp;
...
void __wprintf_buffer_as_file_init(struct __wprintf_buffer_as_file *file,
...
bool __wprintf_buffer_as_file_terminate(struct __wprintf_buffer_as_file *file)
{
