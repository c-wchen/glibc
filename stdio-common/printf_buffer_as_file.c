...
/* Pointer the FILE * write buffer into the active printf_buffer
   area.  */
static void __printf_buffer_as_file_switch_to_buffer(struct __printf_buffer_as_file *file)
{
...
size_t __printf_buffer_as_file_xsputn(FILE *fp, const void *buf, size_t len)
{
    struct __printf_buffer_as_file *file = (struct __printf_buffer_as_file *) fp;
...
void __printf_buffer_as_file_init(struct __printf_buffer_as_file *file,
...
bool __printf_buffer_as_file_terminate(struct __printf_buffer_as_file *file)
{
