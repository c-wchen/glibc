...
static int test_dec_in_one_mode(double d, const char *fmt, const char *expected,
...
static int test_hex_in_one_mode(double d, const char *fmt, const char *const expected[4],
                                const char *mode_name)
{
    char buf[100];
    int ret = snprintf(buf, sizeof buf, fmt, d);
