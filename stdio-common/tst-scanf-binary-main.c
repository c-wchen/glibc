...
static int wrap_vfscanf(FILE *fp, const CHAR *format, ...)
{
    va_list ap;
    va_start(ap, format);
...
static int wrap_vscanf(const CHAR *format, ...)
{
    va_list ap;
    va_start(ap, format);
...
static int wrap_vsscanf(const CHAR *s, const CHAR *format, ...)
{
    va_list ap;
    va_start(ap, format);
...
static void one_check(const CHAR *s, int expected, char expected_c)
{
    int ret;
    FILE *fp;
    int ret_i;
...
static void one_check_b(const CHAR *s, int expected, char expected_c)
{
    int ret;
    FILE *fp;
    unsigned int ret_i;
