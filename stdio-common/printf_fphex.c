...
void __printf_fphex_l_buffer(struct __printf_buffer *buf, locale_t loc,
                             const struct printf_info *info,
                             const void *const *args)
{
...
/* Translate to wide characters, rewriting "." to the actual decimal
   point.  */
void __printf_buffer_flush_fphex_to_wide(struct __printf_buffer_fphex_to_wide *buf)
{
...
void __wprintf_fphex_l_buffer(struct __wprintf_buffer *next, locale_t loc,
                              const struct printf_info *info,
                              const void *const *args)
{
