...
__fortify_function __attribute_overloadable__ ssize_t recv(int __fd, __fortify_clang_overload_arg0(void *,, __buf),
        size_t __n,
        int __flags)
...
__fortify_function __attribute_overloadable__ ssize_t recvfrom(int __fd, __fortify_clang_overload_arg0(void *,
        __restrict, __buf),
