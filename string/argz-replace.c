...
static void str_append(char **to, size_t *to_len, const char *buf, const size_t buf_len)
{
...
error_t __argz_replace(char **argz, size_t *argz_len, const char *str, const char *with,
