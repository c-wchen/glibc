...
static int do_one_test(impl_t *impl, const CHAR *s, int c, const CHAR *exp_res)
{
    return check_result(impl, s, c, exp_res);
}

static void do_test(size_t align, size_t pos, size_t len, int seek_char, int max_char)
