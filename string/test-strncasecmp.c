...
static int check_result(impl_t *impl, const char *s1, const char *s2, size_t n,
                        int exp_result)
{
...
static void do_test(size_t align1, size_t align2, size_t n, size_t len, int max_char,
                    int exp_result)
{
    size_t i;
    char *s1, *s2;
...
static void do_page_tests(void)
{
    char *s1, *s2;
    int exp_result;
...
static void test_locale(const char *locale, int extra_tests)
{
    size_t i, j, k;
