...
static __always_inline void get_next_seq(coll_seq *seq, int nrules, const unsigned char *rulesets,
...
static __always_inline int do_compare(coll_seq *seq1, coll_seq *seq2, int position,
...
int STRCOLL(const STRING_TYPE *s1, const STRING_TYPE *s2, locale_t l)
{
