...
int simple_wcsncmp(const CHAR *s1, const CHAR *s2, size_t n)
{
    wchar_t c1, c2;
...
static void do_one_test(impl_t *impl, const CHAR *s1, const CHAR *s2, size_t n,
                        int exp_result)
{
...
static void do_test_limit(size_t align1, size_t align2, size_t len, size_t n, int max_char,
                          int exp_result)
{
    size_t i, align_n;
    CHAR *s1, *s2;
...
static void do_test_n(size_t align1, size_t align2, size_t len, size_t n, int n_in_bounds,
...
static void do_page_test(size_t offset1, size_t offset2, CHAR *s2)
{
    CHAR *s1;
    int exp_result;
