...
static void do_one_test(impl_t *impl, const CHAR *s1, const CHAR *s2, CHAR *exp_result)
{
...
static void do_test(size_t align1, size_t align2, size_t len1, size_t len2,
                    int fail)
{
