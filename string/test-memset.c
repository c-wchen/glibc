...
static void do_one_test(impl_t *impl, CHAR *s, int c __attribute((unused)), size_t n, int space_below, int space_above)
{
    CHAR buf[n];
    CHAR sentinel = ~c;
    if (space_below) {
...
static void do_test(size_t align, int c, size_t len)
{
