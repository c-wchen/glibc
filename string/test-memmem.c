...
static int check_result(impl_t *impl, const void *haystack, size_t haystack_len,
...
static void do_one_test(impl_t *impl, const void *haystack, size_t haystack_len,
                        const void *needle, size_t needle_len, const void *expected)
{
