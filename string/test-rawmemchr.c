...
static void do_one_test(impl_t *impl, const char *s, int c, char *exp_res)
{
...
static void do_test_bz29234(void)
{
    size_t i, j;
    char *ptr_start;
...
static void do_test(size_t align, size_t pos, size_t len, int seek_char)
{
    size_t i;
    char *result;
