...
char *__old_strtok_r_1c(char *__s, char __sep, char **__nextp)
{
    char *__result;
    if (__s == NULL) {
        __s = *__nextp;
...
char *__old_strsep_1c(char **__s, char __reject)
{
    char *__retval = *__s;
...
char *__old_strsep_2c(char **__s, char __reject1, char __reject2)
{
    char *__retval = *__s;
    if (__retval != NULL) {
        char *__cp = __retval;
...
char *__old_strsep_3c(char **__s, char __reject1, char __reject2, char __reject3)
{
    char *__retval = *__s;
    if (__retval != NULL) {
        char *__cp = __retval;
...
size_t __old_strcspn_c1(const char *__s, int __reject)
{
    size_t __result = 0;
...
size_t __old_strcspn_c2(const char *__s, int __reject1, int __reject2)
{
    size_t __result = 0;
...
size_t __old_strcspn_c3(const char *__s, int __reject1, int __reject2,
                        int __reject3)
{
    size_t __result = 0;
    while (__s[__result] != '\0' && __s[__result] != __reject1
...
size_t __old_strspn_c1(const char *__s, int __accept)
{
    size_t __result = 0;
...
size_t __old_strspn_c2(const char *__s, int __accept1, int __accept2)
{
    size_t __result = 0;
...
size_t __old_strspn_c3(const char *__s, int __accept1, int __accept2,
                       int __accept3)
{
    size_t __result = 0;
...
char *__old_strpbrk_c2(const char *__s, int __accept1, int __accept2)
{
    /* Please note that __accept1 and __accept2 never can be '\0'.  */
...
char *__old_strpbrk_c3(const char *__s, int __accept1, int __accept2, int __accept3)
{
    /* Please note that __accept1 to __accept3 never can be '\0'.  */
    while (*__s != '\0' && *__s != __accept1 && *__s != __accept2
           && *__s != __accept3) {
...
void *__old_mempcpy_small(void *__dest1,
...
void *__old_mempcpy_small(void *__dest, char __src1,
...
# if _STRING_INLINE_unaligned
char *__old_strcpy_small(char *__dest,
                         __uint16_t __src0_2, __uint16_t __src4_2,
                         __uint32_t __src0_4, __uint32_t __src4_4,
                         size_t __srclen)
{
...
# if _STRING_INLINE_unaligned
char *__old_stpcpy_small(char *__dest,
                         __uint16_t __src0_2, __uint16_t __src4_2,
                         __uint32_t __src0_4, __uint32_t __src4_4,
                         size_t __srclen)
{
