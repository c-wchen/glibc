...
static __always_inline size_t find_idx(const USTRING_TYPE **us, int32_t *weight_idx,
...
static int find_position(const USTRING_TYPE *us, const locale_data_t *l_data,
                         const int pass)
{
    int32_t weight_idx;
...
static size_t do_xfrm(const USTRING_TYPE *usrc, STRING_TYPE *dest, size_t n,
...
static size_t do_xfrm_cached(STRING_TYPE *dest, size_t n, const locale_data_t *l_data,
...
size_t STRXFRM(STRING_TYPE *dest, const STRING_TYPE *src, size_t n, locale_t l)
{
