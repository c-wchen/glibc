...
static void do_one_test(int select, const char *format, va_list args,
...
static void do_test_call_varg(const char *format, ...)
{
    va_list args;
...
static void do_test_call_rarg(const char *format, long double arg1, double arg2,
