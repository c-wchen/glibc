...
static void do_test_child(void *clousure)
{
    ...
    ts = timespec_add(ts, (struct timespec) {
        args->tmo.tv_sec, 0
    });
...
static void do_test_child_alarm(void *clousure)
{
    struct child_args *args = (struct child_args *) clousure;
