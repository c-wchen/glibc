...
ATTRIBUTE_PURE_114833 static ptrdiff_t size_sum(size_t a, size_t b)
{
#ifdef ckd_add
    ptrdiff_t sum;
...
ATTRIBUTE_PURE_114833 static ptrdiff_t size_product(ptrdiff_t nitems, ptrdiff_t itemsize)
{
#ifdef ckd_mul
    ptrdiff_t product;
...
ATTRIBUTE_PURE_114833 static ptrdiff_t align_to(ptrdiff_t size, ptrdiff_t alignment)
{
...
static void *growalloc(void *ptr, ptrdiff_t itemsize, ptrdiff_t nitems,
...
static bool componentcheck(char const *name, char const *component,
...
ATTRIBUTE_PURE_114833 static bool same_parent_dirs(char const *a, char const *b)
{
    for (; *a == *b; a++, b++)
        if (!*a) {
            return true;
...
static ptrdiff_t doabbr(char *abbr, struct zone const *zp, char const *letters,
...
ATTRIBUTE_PURE_114833 static bool ciequal(register const char *ap, register const char *bp)
{
...
ATTRIBUTE_PURE_114833 static bool itsabbr(register const char *abbr, register const char *word)
{
...
ATTRIBUTE_PURE_114833 static bool ciprefix(char const *abbr, char const *word)
{
    do
        if (!*abbr) {
            return true;
...
ATTRIBUTE_PURE_114833 static zic_t oadd(zic_t t1, zic_t t2)
{
#ifdef ckd_add
    zic_t sum;
...
ATTRIBUTE_PURE_114833 static zic_t tadd(zic_t t1, zic_t t2)
{
#ifdef ckd_add
    zic_t sum;
