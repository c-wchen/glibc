...
__attribute_warn_unused_result__ re_string_allocate(re_string_t *pstr, const char *str, Idx len, Idx init_len,
...
static reg_errcode_t
__attribute_warn_unused_result__ re_string_construct(re_string_t *pstr, const char *str, Idx len,
        RE_TRANSLATE_TYPE trans, bool icase, const re_dfa_t *dfa)
{
    reg_errcode_t ret;
...
static reg_errcode_t
__attribute_warn_unused_result__ re_string_realloc_buffers(re_string_t *pstr, Idx new_buf_len)
{
#ifdef RE_ENABLE_I18N
...
static void re_string_construct_common(const char *str, Idx len, re_string_t *pstr,
                                       RE_TRANSLATE_TYPE trans, bool icase,
                                       const re_dfa_t *dfa)
{
...
static reg_errcode_t
__attribute_warn_unused_result__ build_wcs_upper_buffer(re_string_t *pstr)
{
    mbstate_t prev_st;
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_alloc(re_node_set *set, Idx size)
{
    set->alloc = size;
    set->nelem = 0;
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_init_2(re_node_set *set, Idx elem1, Idx elem2)
{
    set->alloc = 2;
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_init_copy(re_node_set *dest, const re_node_set *src)
{
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_add_intersect(re_node_set *dest, const re_node_set *src1,
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_init_union(re_node_set *dest, const re_node_set *src1,
        const re_node_set *src2)
{
    Idx i1, i2, id;
...
static reg_errcode_t
__attribute_warn_unused_result__ re_node_set_merge(re_node_set *dest, const re_node_set *src)
{
...
static bool
__attribute_warn_unused_result__ re_node_set_insert(re_node_set *set, Idx elem)
{
    Idx idx;
...
static bool
__attribute_warn_unused_result__ re_node_set_insert_last(re_node_set *set, Idx elem)
{
    /* Realloc if we need.  */
    if (set->alloc == set->nelem) {
        Idx *new_elems;
...
static re_hashval_t calc_state_hash(const re_node_set *nodes, unsigned int context)
{
...
__attribute_warn_unused_result__ re_acquire_state(reg_errcode_t *err, const re_dfa_t *dfa,
        const re_node_set *nodes)
{
    re_hashval_t hash;
...
static re_dfastate_t *
__attribute_warn_unused_result__ re_acquire_state_context(reg_errcode_t *err, const re_dfa_t *dfa,
...
static re_dfastate_t *
__attribute_warn_unused_result__ create_ci_newstate(const re_dfa_t *dfa, const re_node_set *nodes,
        re_hashval_t hash)
{
    Idx i;
    reg_errcode_t err;
...
static re_dfastate_t *
__attribute_warn_unused_result__ create_cd_newstate(const re_dfa_t *dfa, const re_node_set *nodes,
