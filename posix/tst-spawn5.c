...
static void spawn_closefrom_test(posix_spawn_file_actions_t *fa, int lowfd, int highfd,
...
static void do_test_closefrom(void)
{
    ...
    /* Close a range and add some file actions.  */
    {
        ...
        spawn_closefrom_test(&fa, lowfd, lowfd, (int[]) {
            lowfd, lowfd + 1
        }, 2);
