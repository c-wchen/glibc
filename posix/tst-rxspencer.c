...
static void glibc_re_syntax(char *str)
{
...
static char *mb_replace(char *dst, const char c)
{
    switch (c) {
...
static char *mb_frob_string(const char *str, const char *letters)
{
    char *ret, *dst;
    const char *src;
...
static char *mb_frob_pattern(const char *str, const char *letters)
{
    char *ret, *dst;
    const char *src;
...
static int check_match(regmatch_t *rm, int idx, const char *string,
...
static int mb_test(const char *pattern, int cflags, const char *string, int eflags,
...
static int mb_tests(const char *pattern, int cflags, const char *string, int eflags,
