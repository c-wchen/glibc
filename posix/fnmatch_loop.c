...
static int FCT(const CHAR *pattern, const CHAR *string, const CHAR *string_end,
...
static const CHAR *END(const CHAR *pattern)
{
...
static int EXT(INT opt, const CHAR *pattern, const CHAR *string, const CHAR *string_end,
