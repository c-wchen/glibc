...
static char *w_addmem(char *buffer, size_t *actlen, size_t *maxlen, const char *str,
                      size_t len)
{
...
static int parse_backslash(char **word, size_t *word_length, size_t *max_length,
...
static int parse_qtd_backslash(char **word, size_t *word_length, size_t *max_length,
                               const char *words, size_t *offset)
{
...
static int parse_tilde(char **word, size_t *word_length, size_t *max_length,
...
static int do_parse_glob(const char *glob_word, char **word, size_t *word_length,
...
static int parse_glob(char **word, size_t *word_length, size_t *max_length,
                      const char *words, size_t *offset, int flags,
...
static int parse_squote(char **word, size_t *word_length, size_t *max_length,
                        const char *words, size_t *offset)
{
...
static int parse_arith(char **word, size_t *word_length, size_t *max_length,
...
static pid_t exec_comm_child(char *comm, int *fildes, bool showerr, bool noexec)
{
    pid_t pid = -1;
...
static int exec_comm(char *comm, char **word, size_t *word_length, size_t *max_length,
...
static int parse_comm(char **word, size_t *word_length, size_t *max_length,
...
static int parse_backtick(char **word, size_t *word_length, size_t *max_length,
                          const char *words, size_t *offset, int flags,
                          wordexp_t *pwordexp, const char *ifs, const char *ifs_white)
{
    /* We are poised just after "`" */
