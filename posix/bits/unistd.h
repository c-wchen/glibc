...
__fortify_function __attribute_overloadable__ __wur ssize_t read(int __fd, __fortify_clang_overload_arg0(void *,,
...
__fortify_function __attribute_overloadable__ __wur ssize_t pread(int __fd, __fortify_clang_overload_arg0(void *,,
        __buf),
...
__fortify_function __attribute_overloadable__ __wur ssize_t pread64(int __fd, __fortify_clang_overload_arg0(void *,,
        __buf),
        size_t __nbytes, __off64_t __offset)
__fortify_clang_warning_only_if_bos0_lt(__nbytes, __buf,
...
__fortify_function __attribute_overloadable__ __wur char *__NTH(getcwd(__fortify_clang_overload_arg(char *,, __buf),
        size_t __size))
...
__fortify_function __attribute_overloadable__ size_t __NTH(confstr(int __name, __fortify_clang_overload_arg(char *,,
        __buf),
        size_t __len))
__fortify_clang_warning_only_if_bos_lt(__len, __buf,
...
__fortify_function __attribute_overloadable__ int __NTH(getgroups(int __size,
...
__fortify_function __attribute_overloadable__ int __NTH(ttyname_r(int __fd,
...
__fortify_function __attribute_overloadable__ int getlogin_r(__fortify_clang_overload_arg(char *,, __buf),
        size_t __buflen)
__fortify_clang_warning_only_if_bos_lt(__buflen, __buf,
...
__fortify_function __attribute_overloadable__ int __NTH(gethostname(__fortify_clang_overload_arg(char *,, __buf),
        size_t __buflen))
__fortify_clang_warning_only_if_bos_lt(__buflen, __buf,
...
__fortify_function __attribute_overloadable__ int __NTH(getdomainname(__fortify_clang_overload_arg(char *,, __buf),
        size_t __buflen))
__fortify_clang_warning_only_if_bos_lt(__buflen, __buf,
