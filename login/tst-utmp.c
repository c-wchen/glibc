...
static int simulate_login(const char *line, const char *user)
{
    int n;
...
static int simulate_logout(const char *line)
{
    int n;
...
static int check_login(const char *line)
{
    struct utmp *up;
    struct utmp ut;
    int n;
...
static int check_logout(const char *line)
{
    struct utmp ut;
