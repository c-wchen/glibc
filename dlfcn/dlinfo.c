...
static int dlinfo_implementation(void *handle, int request, void *arg)
{
...
#ifdef SHARED
int ___dlinfo(void *handle, int request, void *arg)
{
...
int __dlinfo(void *handle, int request, void *arg)
{
    return dlinfo_implementation(handle, request, arg);
}
