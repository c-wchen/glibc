...
static void *dlmopen_implementation(Lmid_t nsid, const char *file, int mode,
                                    void *dl_caller)
{
...
#ifdef SHARED
void *___dlmopen(Lmid_t nsid, const char *file, int mode)
{
...
void *__dlmopen(Lmid_t nsid, const char *file, int mode, void *dl_caller)
{
    return dlmopen_implementation(nsid, file, mode, RETURN_ADDRESS(0));
}
