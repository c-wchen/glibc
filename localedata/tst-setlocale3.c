...
static char *setlocale_copy(int category, const char *locale)
{
...
static void setlocale_fail(const char *envstring)
{
...
static void setlocale_success(const char *envstring)
{
    setenv("LC_CTYPE", envstring, 1);
...
static void setlocale_ignore(const char *to_ignore)
{
