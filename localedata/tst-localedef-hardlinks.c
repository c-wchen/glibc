...
void check_link(struct test_data step)
{
...
static void run_localedef(void *step)
{
...
static struct test_data step[4] = {
    ...
    {
        .argv = {
            NULL, "--no-archive", "--no-hard-links", "-i", "/test1_locale",
            TEST1DIR, NULL
        },
        .output = TEST1DIR "/LC_CTYPE",
        .st_nlink = 1
    ...
    {
        .argv = {
            NULL, "--no-archive", "--no-hard-links", "-i", "/test2_locale",
            TEST1DIR, NULL
        },
        .output = TEST2DIR "/LC_CTYPE",
        .st_nlink = 1
