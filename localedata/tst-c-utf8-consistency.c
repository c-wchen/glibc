...
static void switch_to_c_utf8(void)
{
...
static char *str_utf8(nl_item item)
{
    if (use_nl_langinfo_l) {
...
static wchar_t *wstr(nl_item item)
{
    return (wchar_t *) str(item);
}

static wchar_t *wstr_utf8(nl_item item)
{
    return (wchar_t *) str_utf8(item);
}

static int byte(nl_item item)
{
    return (signed char) * str(item);
}

static int byte_utf8(nl_item item)
{
    return (signed char) * str_utf8(item);
}

static int word(nl_item item)
{
    union {
        char *ptr;
        int word;
...
static int word_utf8(nl_item item)
{
    union {
        char *ptr;
        int word;
