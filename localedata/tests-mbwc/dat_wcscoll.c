    ...
    {   { Twcscoll, TST_LOC_de },
        {
            ...
            { /*input.*/ { { 0x0000, 0x00E2, 0x00E3, 0x0000 },
                    { 0x00E1, 0x00E1, 0x00E3, 0x0000 },
                },  /* #4 */
                /*expect*/ { 0, 0, 0, -1,           },
            },
            { /*input.*/ { { 0x00E1, 0x0042, 0x00E3, 0x0000 },
                    { 0x00E1, 0x0061, 0x00E3, 0x0000 },
                },  /* #5 */
                /*expect*/ { 0, 0, 0, +1,           },
            },
            { /*input.*/ { { 0x00E1, 0x0061, 0x00E3, 0x0000 },
                    { 0x00E1, 0x0042, 0x00E3, 0x0000 },
                },  /* #6 */
                /*expect*/ { 0, 0, 0, -1,           },
            },
            { /*input.*/ { { 0x00E1, 0x00E2, 0x0000        },
                    { 0x00E1, 0x00E2, 0x00E9, 0x0000 },
                },  /* #7 */
                /*expect*/ { 0, 0, 0, -1,           },
            },
            ...
            { /*input.*/ { { 0x00E1, 0x0092, 0x00E9, 0x0000 },
                    { 0x00E1, 0x008E, 0x00E9, 0x0000 },
                },  /* #9 */
                /*expect*/ { 0, 0, 0, +1,            },
            },
            { /*input.*/ { { 0x00E1, 0x008E, 0x00E9, 0x0000 },
                    { 0x00E1, 0x0092, 0x00E9, 0x0000 },
                },  /* #10 */
                /*expect*/ { 0, 0, 0, -1,            },
            },
            { .is_last = 1 }
    ...
    {   { Twcscoll, TST_LOC_enUS },
        {
            ...
            { /*input.*/ { { 0x0041, 0x0092, 0x0049, 0x0000 },
                    { 0x0041, 0x008E, 0x0049, 0x0000 },
                },  /* #9 */
                /*expect*/ { 0, 0, 0, 0,             },
            },
            { /*input.*/ { { 0x0041, 0x008E, 0x0049, 0x0000 },
                    { 0x0041, 0x0092, 0x0049, 0x0000 },
                },  /* #10 */
                /*expect*/ { 0, 0, 0, 0,             },
            },
            { .is_last = 1 }
