...
static void setxid_unmark_thread(struct xid_command *cmdp, struct pthread *t)
{
    int ch;
...
static int setxid_signal_thread(struct xid_command *cmdp, struct pthread *t)
{
...
int
attribute_hidden __nptl_setxid(struct xid_command *cmdp)
{
    int signalled;
    int result;
