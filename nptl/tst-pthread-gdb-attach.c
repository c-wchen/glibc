...
static bool read_elf_header(const char *path, struct elf_prefix *elf)
{
...
static void write_gdbscript(const char *path, int tested_pid)
{
...
static void *subprocess_thread(void *closure)
{
...
static void in_subprocess(void *arg)
{
...
static void gdb_process(const char *gdb_path, const char *gdbscript, pid_t *tested_pid)
{
