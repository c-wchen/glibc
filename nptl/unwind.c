...
static _Unwind_Reason_Code unwind_stop(int version, _Unwind_Action actions,
...
static void unwind_cleanup(_Unwind_Reason_Code reason, struct _Unwind_Exception *exc)
{
