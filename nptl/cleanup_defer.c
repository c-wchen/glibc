...
void
__cleanup_fct_attribute ___pthread_register_cancel_defer(__pthread_unwind_buf_t *buf)
{
...
void
__cleanup_fct_attribute ___pthread_unregister_cancel_restore(__pthread_unwind_buf_t *buf)
{
    struct pthread *self = THREAD_SELF;
    struct pthread_unwind_buf *ibuf = (struct pthread_unwind_buf *) buf;
