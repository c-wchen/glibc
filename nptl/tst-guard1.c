...
static inline size_t adjust_stacksize(size_t stacksize)
{
...
get_current_stack_info(void)
{
    ...
    return (struct stack_t) {
        stack, stacksize, guard, guardsize
    };
}
...
get_thread_args(const pthread_attr_t *attr)
{
    ...
    return (struct thread_args_t) {
        stacksize, guardsize
    };
}

static void set_thread_args(pthread_attr_t *attr, const struct thread_args_t *args)
{
