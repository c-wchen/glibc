...
static void *thr(void *unused __attribute__((unused)))
{
    pthread_attr_t attr;
    int ret;
...
static int run_threads(const pthread_attr_t *attr)
{
    pthread_t t;
    void *tret = NULL;
...
static int verify_detach_result(pthread_attr_t *attr)
{
    int state;
...
static int do_detach_test(void)
{
    pthread_attr_t attr;
...
static int verify_affinity_result(pthread_attr_t *attr)
{
    cpu_set_t cpuset;
...
static int do_affinity_test(void)
{
    pthread_attr_t attr;
...
static int verify_sched_result(pthread_attr_t *attr)
{
...
static int verify_guardsize_result(pthread_attr_t *attr)
{
    size_t guard;
...
static int do_guardsize_test(void)
{
...
static int verify_stacksize_result(pthread_attr_t *attr)
{
    size_t stack;
...
static int do_stacksize_test(void)
{
    long int pagesize = sysconf(_SC_PAGESIZE);
    pthread_attr_t attr;
