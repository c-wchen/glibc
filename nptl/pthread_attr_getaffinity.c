...
int __pthread_attr_getaffinity_new(const pthread_attr_t *attr, size_t cpusetsize,
                                   cpu_set_t *cpuset)
{
...
int __pthread_attr_getaffinity_old(const pthread_attr_t *attr, cpu_set_t *cpuset)
{
