...
static int __futex_abstimed_wait_common32(unsigned int *futex_word,
...
static int __futex_abstimed_wait_common64(unsigned int *futex_word,
        unsigned int expected, int op,
        const struct __timespec64 *abstime,
        int private, bool cancel)
{
...
static int __futex_abstimed_wait_common(unsigned int *futex_word,
