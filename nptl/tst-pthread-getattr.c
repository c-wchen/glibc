...
static volatile uintptr_t allocate_and_test(char *target)
{
...
static int get_self_pthread_attr(const char *id, void **stackaddr, size_t *stacksize)
{
    pthread_attr_t attr;
    int ret;
...
static int check_stack_top(void)
{
