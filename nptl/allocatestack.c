...
static void *allocate_thread_stack(size_t size, size_t guardsize)
{
...
static inline bool setup_stack_prot(char *mem, size_t size, struct pthread *pd,
...
static inline bool adjust_stack_prot(char *mem, size_t size, const struct pthread *pd,
                                     size_t guardsize, size_t pagesize_m1)
{
...
static __always_inline void advise_stack_range(void *mem, size_t size, uintptr_t pd, size_t guardsize)
{
