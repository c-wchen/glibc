...
static bool ftw_allocate(struct ftw_data *data, size_t newsize)
{
...
static int add_object(struct ftw_data *data, struct STRUCT_STAT *st)
{
...
static inline int find_object(struct ftw_data *data, struct STRUCT_STAT *st)
{
...
static int process_entry(struct ftw_data *data, struct dir_data *dir, const char *name,
...
int NFTW_NEW_NAME(const char *path, NFTW_FUNC_T func, int descriptors, int flags)
{
    if (flags
...
int
attribute_compat_text_section NFTW_OLD_NAME(const char *path, NFTW_FUNC_T func, int descriptors, int flags)
{
