...
__fortify_function __attribute_overloadable__ int open(__fortify_clang_overload_arg(const char *,, __path), int __oflag)
...
__fortify_function int open64(const char *__path, int __oflag, ...)
{
    if (__va_arg_pack_len() > 1) {
...
# elif __fortify_use_clang
__fortify_function_error_function __attribute_overloadable__ int open64(const char *__path, int __oflag, mode_t __mode,
        ...)
__fortify_clang_unavailable("open64 can be called either with 2 or 3 arguments, not more");

__fortify_function __attribute_overloadable__ int open64(__fortify_clang_overload_arg(const char *,, __path),
        int __oflag)
...
# elif __fortify_use_clang
__fortify_function_error_function __attribute_overloadable__ int openat(int __fd, const char *__path, int __oflag,
        mode_t __mode, ...)
__fortify_clang_unavailable("openat can be called either with 3 or 4 arguments, not more");

__fortify_function __attribute_overloadable__ int openat(int __fd, __fortify_clang_overload_arg(const char *,, __path),
        int __oflag)
__fortify_clang_prefer_this_overload
__fortify_clang_error(__OPEN_NEEDS_MODE(__oflag),
                      "openat with O_CREAT or O_TMPFILE in third argument needs 4 arguments")
...
#  ifdef __va_arg_pack_len
__fortify_function int openat64(int __fd, const char *__path, int __oflag, ...)
{
    if (__va_arg_pack_len() > 1) {
...
# elif __fortify_use_clang
__fortify_function_error_function __attribute_overloadable__ int openat64(int __fd, const char *__path, int __oflag,
        mode_t __mode, ...)
__fortify_clang_unavailable("openat64 can be called either with 3 or 4 arguments, not more");

__fortify_function __attribute_overloadable__ int openat64(int __fd, __fortify_clang_overload_arg(const char *,,
        __path),
        int __oflag)
__fortify_clang_prefer_this_overload
__fortify_clang_error(__OPEN_NEEDS_MODE(__oflag),
