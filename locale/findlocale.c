...
/* Checks if the name is actually present, that is, not NULL and not
   empty.  */
static inline int name_present(const char *name)
{
...
static inline int valid_locale_name(const char *name)
{
    /* Not set.  */
...
/* Calling this function assumes the lock for handling global locale data
   is acquired.  */
void _nl_remove_locale(int locale, struct __locale_data *data)
{
