...
static struct section_list *make_seclist_elem(struct locale_collate_t *collate, const char *string,
        struct section_list *next)
{
...
static struct element_t *new_element(struct locale_collate_t *collate, const char *mbs, size_t mbslen,
...
static struct symbol_t *new_symbol(struct locale_collate_t *collate, const char *name, size_t len)
{
...
static int check_duplicate(struct linereader *ldfile, struct locale_collate_t *collate,
...
static void read_directions(struct linereader *ldfile, struct token *arg,
                            const struct charmap_t *charmap,
...
static struct element_t *find_element(struct linereader *ldfile, struct locale_collate_t *collate,
...
static void unlink_element(struct locale_collate_t *collate)
{
...
static void insert_weights(struct linereader *ldfile, struct element_t *elem,
                           const struct charmap_t *charmap,
                           struct repertoire_t *repertoire, struct localedef_t *result,
...
static int insert_value(struct linereader *ldfile, const char *symstr, size_t symlen,
...
static void handle_ellipsis(struct linereader *ldfile, const char *symstr, size_t symlen,
...
static void collate_startup(struct linereader *ldfile, struct localedef_t *locale,
...
static int32_t output_weight(struct obstack *pool, struct locale_collate_t *collate,
                             struct element_t *elem)
{
    size_t cnt;
    int32_t retval;
...
static int32_t output_weightwc(struct obstack *pool, struct locale_collate_t *collate,
                               struct element_t *elem)
{
    size_t cnt;
    int32_t retval;
...
void collate_output(struct localedef_t *locale, const struct charmap_t *charmap,
...
void collate_read(struct linereader *ldfile, struct localedef_t *result,
