...
static inline void set_big_endian(bool big_endian)
{
...
static inline void maybe_swap_uint32_array(uint32_t *array, size_t n)
{
...
static inline void maybe_swap_uint32_obstack(struct obstack *obstack, size_t n)
{
