...
static void time_startup(struct linereader *lr, struct localedef_t *locale,
                         int ignore_content)
{
    if (!ignore_content)
...
void time_output(struct localedef_t *locale, const struct charmap_t *charmap,
...
void time_read(struct linereader *ldfile, struct localedef_t *result,
