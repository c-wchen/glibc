...
static void identification_startup(struct linereader *lr, struct localedef_t *locale,
                                   int ignore_content)
{
    if (!ignore_content) {
...
void identification_read(struct linereader *ldfile, struct localedef_t *result,
