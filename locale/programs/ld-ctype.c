...
static inline void wctrans_table_add(struct wctrans_table *t, uint32_t wc, uint32_t mapped_wc)
{
...
void ctype_output(struct localedef_t *locale, const struct charmap_t *charmap,
...
/* Local functions.  */
static void ctype_class_new(struct linereader *lr, struct locale_ctype_t *ctype,
                            const char *name)
{
    size_t cnt;
...
static void ctype_map_new(struct linereader *lr, struct locale_ctype_t *ctype,
                          const char *name, const struct charmap_t *charmap)
{
    size_t max_chars = 0;
    size_t cnt;
...
static uint32_t *find_idx(struct locale_ctype_t *ctype, uint32_t **table, size_t *max,
...
static int get_character(struct token *now, const struct charmap_t *charmap,
                         struct repertoire_t *repertoire,
...
/* Ellipsis like in `<foo123>..<foo12a>' or `<j1234>....<j1245>' and
   the .(2). counterparts.  */
static void charclass_symbolic_ellipsis(struct linereader *ldfile,
                                        struct locale_ctype_t *ctype,
                                        const struct charmap_t *charmap,
                                        struct repertoire_t *repertoire,
                                        struct token *now,
...
static void charclass_ucs4_ellipsis(struct linereader *ldfile,
                                    struct locale_ctype_t *ctype,
                                    const struct charmap_t *charmap,
                                    struct repertoire_t *repertoire,
...
static void charclass_charcode_ellipsis(struct linereader *ldfile,
                                        struct locale_ctype_t *ctype,
                                        const struct charmap_t *charmap,
                                        struct repertoire_t *repertoire,
...
static uint32_t *find_translit2(struct locale_ctype_t *ctype, const struct charmap_t *charmap,
                                uint32_t wch)
{
...
uint32_t *find_translit(struct localedef_t *locale, const struct charmap_t *charmap,
                        uint32_t wch)
{
    struct locale_ctype_t *ctype;
...
static uint32_t *read_widestring(struct linereader *ldfile, struct token *now,
                                 const struct charmap_t *charmap,
                                 struct repertoire_t *repertoire)
{
    uint32_t *wstr;
...
static void read_translit_entry(struct linereader *ldfile, struct locale_ctype_t *ctype,
...
static void read_translit_ignore_entry(struct linereader *ldfile,
                                       struct locale_ctype_t *ctype,
                                       const struct charmap_t *charmap,
                                       struct repertoire_t *repertoire)
{
...
void ctype_read(struct linereader *ldfile, struct localedef_t *result,
...
static void set_one_default(struct locale_ctype_t *ctype,
                            const struct charmap_t *charmap,
...
static inline void wctype_table_init(struct wctype_table *t)
{
    t->level1 = NULL;
...
/* Add one entry.  */
static void wctype_table_add(struct wctype_table *t, uint32_t wc)
{
...
/* Finalize and shrink.  */
static void add_locale_wctype_table(struct locale_file *file, struct wctype_table *t)
{
    size_t i, j, k;
...
static struct translit_t **translit_flatten(struct locale_ctype_t *ctype,
        const struct charmap_t *charmap,
...
static void allocate_arrays(struct locale_ctype_t *ctype, const struct charmap_t *charmap,
                            struct repertoire_t *repertoire)
{
    size_t idx, nr;
    const void *key;
