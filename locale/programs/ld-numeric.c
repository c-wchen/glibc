...
static void numeric_startup(struct linereader *lr, struct localedef_t *locale,
                            int ignore_content)
{
    if (!ignore_content) {
...
void numeric_output(struct localedef_t *locale, const struct charmap_t *charmap,
...
void numeric_read(struct linereader *ldfile, struct localedef_t *result,
