...
static void measurement_startup(struct linereader *lr, struct localedef_t *locale,
                                int ignore_content)
{
    if (!ignore_content)
...
void measurement_read(struct linereader *ldfile, struct localedef_t *result,
