...
void repertoire_complain(const char *name)
{
...
static const struct keyword_t *repertoiremap_hash(const char *str, size_t len)
{
...
static void repertoire_new_char(struct linereader *lr, hash_table *ht, hash_table *rt,
...
uint32_t repertoire_find_value(const struct repertoire_t *rep, const char *name,
                               size_t len)
{
    void *result;
...
const char *repertoire_find_symbol(const struct repertoire_t *rep, uint32_t ucs)
{
    void *result;
