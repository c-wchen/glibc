...
static void monetary_startup(struct linereader *lr, struct localedef_t *locale,
                             int ignore_content)
{
    if (!ignore_content) {
...
void monetary_output(struct localedef_t *locale, const struct charmap_t *charmap,
...
void monetary_read(struct linereader *ldfile, struct localedef_t *result,
