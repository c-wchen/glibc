...
static void _nl_intern_locale_data_fill_cache_ctype(struct __locale_data *locdata)
{
...
static void _nl_intern_locale_data_fill_cache(int category, struct __locale_data *locdata)
{
    switch (category) {
        case LC_CTYPE:
...
/* Returns the number of bytes allocated of struct __locale_data for
   CATEGORY.  */
static size_t _nl_intern_locale_data_extra_size(int category)
{
    switch (category) {
        case LC_CTYPE:
...
void _nl_unload_locale(int category, struct __locale_data *locale)
{
