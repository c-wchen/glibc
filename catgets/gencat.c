...
static struct catalog *read_input_file(struct catalog *current, const char *fname)
{
    FILE *fp;
    char *buf;
    size_t len;
...
static void normalize_line(const char *fname, size_t line, iconv_t cd, wchar_t *string,
...
static int open_conversion(const char *codeset, iconv_t *cd_towcp, iconv_t *cd_tombp,
