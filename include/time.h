...
static inline bool in_time_t_range(__time64_t t)
{
    time_t s = t;
    return s == t;
}
...
static inline struct __timespec64 valid_timeval_to_timespec64(const struct timeval tv)
{
...
static inline struct __timeval64 valid_timeval_to_timeval64(const struct timeval tv)
{
...
static inline struct timeval valid_timeval64_to_timeval(const struct __timeval64 tv64)
{
    struct timeval tv;
...
static inline struct __timespec64 timeval64_to_timespec64(const struct __timeval64 tv64)
{
    struct __timespec64 ts64;
...
static inline struct __timespec64 valid_timespec_to_timespec64(const struct timespec ts)
{
    struct __timespec64 ts64;
...
static inline struct timespec valid_timespec64_to_timespec(const struct __timespec64 ts64)
{
    struct timespec ts;
...
static inline struct timeval valid_timespec64_to_timeval(const struct __timespec64 ts64)
{
    struct timeval tv;
...
static inline struct __timeval64 timespec64_to_timeval64(const struct __timespec64 ts64)
{
    struct __timeval64 tv64;
...
static inline struct __timeval64 valid_timeval32_to_timeval64(const struct __timeval32 tv)
{
    return (struct __timeval64) {
        tv.tv_sec, tv.tv_usec
    };
}

static inline struct __timeval32 valid_timeval64_to_timeval32(const struct __timeval64 tv64)
{
    return (struct __timeval32) {
        tv64.tv_sec, tv64.tv_usec
    };
}

static inline struct timeval valid_timeval32_to_timeval(const struct __timeval32 tv)
{
...
static inline struct __timeval32 valid_timeval_to_timeval32(const struct timeval tv)
{
    return (struct __timeval32) {
        tv.tv_sec, tv.tv_usec
    };
...
static inline struct timespec valid_timeval32_to_timespec(const struct __timeval32 tv)
{
...
static inline struct __timeval32 valid_timespec_to_timeval32(const struct timespec ts)
{
    return (struct __timeval32) {
        (time_t) ts.tv_sec, ts.tv_nsec / 1000
    };
}

static inline struct __timeval64 valid_timespec_to_timeval64(const struct timespec ts)
{
    return (struct __timeval64) {
        (time_t) ts.tv_sec, ts.tv_nsec / 1000
    };
...
static inline bool valid_nanoseconds(__syscall_slong_t ns)
{
...
static inline __time64_t time64_now(void)
{
