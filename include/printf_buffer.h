...
static inline void __printf_buffer_mark_failed(struct __printf_buffer *buf)
{
...
/* Returns true if the sticky error indicator of the buffer has been
   set to failed.  */
static inline bool __attribute_warn_unused_result__ __printf_buffer_has_failed(struct __printf_buffer *buf)
{
...
static inline void __printf_buffer_init_end(struct __printf_buffer *buf, char *base, char *end,
        enum __printf_buffer_mode mode)
{
    buf->write_base = base;
    buf->write_ptr = base;
...
static inline void __printf_buffer_init(struct __printf_buffer *buf, char *base, size_t len,
                                        enum __printf_buffer_mode mode)
{
...
/* Writes CH to BUF.  */
static inline void __printf_buffer_putc(struct __printf_buffer *buf, char ch)
{
...
static inline void __printf_buffer_pad(struct __printf_buffer *buf, char ch, ssize_t count)
{
    if (count > 0) {
...
static inline void __printf_buffer_puts(struct __printf_buffer *buf, const char *s)
{
...
static inline void __wprintf_buffer_mark_failed(struct __wprintf_buffer *buf)
{
    buf->mode = __wprintf_buffer_mode_failed;
}

static inline bool __attribute_warn_unused_result__ __wprintf_buffer_has_failed(struct __wprintf_buffer *buf)
{
    return buf->mode == __wprintf_buffer_mode_failed;
}

static inline void __wprintf_buffer_init(struct __wprintf_buffer *buf,
...
static inline void __wprintf_buffer_putc(struct __wprintf_buffer *buf, wchar_t ch)
{
    if (buf->write_ptr != buf->write_end) {
        *buf->write_ptr++ = ch;
    } else {
...
static inline void __wprintf_buffer_pad(struct __wprintf_buffer *buf, char ch, ssize_t count)
{
    if (count > 0) {
