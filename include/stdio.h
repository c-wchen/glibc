...
static inline void fseterr_unlocked(FILE *fp)
{
...
__extern_inline int __NTH(__ferror_unlocked(FILE *__stream))
{
    return __ferror_unlocked_body(__stream);
}

__extern_inline int __getc_unlocked(FILE *__fp)
{
    return __getc_unlocked_body(__fp);
}

__extern_inline int __putc_unlocked(int __c, FILE *__stream)
{
