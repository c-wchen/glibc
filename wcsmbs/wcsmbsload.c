...
attribute_hidden
struct __gconv_step *__wcsmbs_getfct(const char *to, const char *from, size_t *nstepsp)
{
    size_t nsteps;
...
int __wcsmbs_named_conv(struct gconv_fcts *copy, const char *name)
{
...
void _nl_cleanup_ctype(struct __locale_data *locale)
{
