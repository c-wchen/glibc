...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wmemcpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __s1),
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wmemmove(__fortify_clang_overload_arg(wchar_t *,, __s1),
...
#ifdef __USE_GNU
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wmempcpy(__fortify_clang_overload_arg(wchar_t *,
        __restrict, __s1),
        const wchar_t *__restrict __s2, size_t __n))
__fortify_clang_warning_only_if_bos0_lt2(__n, __s1, sizeof(wchar_t),
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wmemset(__fortify_clang_overload_arg(wchar_t *,, __s),
        wchar_t __c,
        size_t __n))
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcscpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcpcpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src))
{
    size_t __sz = __glibc_objsize(__dest);
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcsncpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcpncpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src, size_t __n))
__fortify_clang_warning_only_if_bos0_lt2(__n, __dest, sizeof(wchar_t),
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcscat(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src))
{
    size_t __sz = __glibc_objsize(__dest);
...
__fortify_function __attribute_overloadable__ wchar_t *__NTH(wcsncat(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src, size_t __n))
{
    size_t __sz = __glibc_objsize(__dest);
...
#ifdef __USE_MISC
__fortify_function __attribute_overloadable__ size_t __NTH(wcslcpy(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src, size_t __n))
__fortify_clang_warning_only_if_bos0_lt2(__n, __dest, sizeof(wchar_t),
...
__fortify_function __attribute_overloadable__ size_t __NTH(wcslcat(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dest),
        const wchar_t *__restrict __src, size_t __n))
{
    if (__glibc_objsize(__dest) != (size_t) -1
...
#ifdef __va_arg_pack
__fortify_function int __NTH(swprintf(wchar_t *__restrict __s, size_t __n,
...
__fortify_function_error_function __attribute_overloadable__ int __NTH(swprintf(__fortify_clang_overload_arg(wchar_t *,
        __restrict, __s),
...
# ifdef __va_arg_pack
__fortify_function int wprintf(const wchar_t *__restrict __fmt, ...)
{
    return __wprintf_chk(__USE_FORTIFY_LEVEL - 1, __fmt, __va_arg_pack());
}

__fortify_function int fwprintf(__FILE *__restrict __stream, const wchar_t *__restrict __fmt, ...)
{
...
__fortify_function int vfwprintf(__FILE *__restrict __stream,
                                 const wchar_t *__restrict __fmt, __gnuc_va_list __ap)
{
...
#endif
__fortify_function __attribute_overloadable__ __wur wchar_t *fgetws(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __s), int __n,
...
#ifdef __USE_GNU
__fortify_function __attribute_overloadable__ __wur wchar_t *fgetws_unlocked(__fortify_clang_overload_arg(wchar_t *,
        __restrict, __s),
...
__fortify_function __attribute_overloadable__ __wur size_t __NTH(wcrtomb(__fortify_clang_overload_arg(char *,
        __restrict, __s),
...
__fortify_function __attribute_overloadable__ size_t __NTH(mbsrtowcs(__fortify_clang_overload_arg(wchar_t *, __restrict,
        __dst),
...
__fortify_function __attribute_overloadable__ size_t __NTH(wcsrtombs(__fortify_clang_overload_arg(char *, __restrict,
        __dst),
        const wchar_t **__restrict __src,
        size_t __len, mbstate_t *__restrict __ps))
...
__fortify_function __attribute_overloadable__ size_t __NTH(mbsnrtowcs(__fortify_clang_overload_arg(wchar_t *,
        __restrict, __dst),
...
__fortify_function __attribute_overloadable__ size_t __NTH(wcsnrtombs(__fortify_clang_overload_arg(char *, __restrict,
        __dst),
