...
static bool leapyear(long_int year)
{
...
static long_int ydhms_diff(long_int year1, long_int yday1, int hour1, int min1, int sec1,
...
/* Use CONVERT to convert T to a struct tm value in *TM.  T must be in
   ...
   failure.  */
static struct tm *convert_time(struct tm * (*convert)(const __time64_t *, struct tm *),
...
static struct tm *ranged_convert(struct tm * (*convert)(const __time64_t *, struct tm *),
...
__time64_t __mktime_internal(struct tm *tp,
...
__time64_t __mktime64(struct tm *tp)
{
