/* Data-driven tests for strftime/strptime.
   Copyright (C) 2019-2025 Free Software Foundation, Inc.  This file is
...
static void print_string_hex(const char *header, const char *str)
{
    int tictoc = 0;
    const char *s = str;
    wchar_t w[STRBUFLEN];
...
static void compare_strings(const char *got, const char *expected,
...
static void tm_to_printed(struct tm *tm, char *buffer)
{
    const char *wn;
    char temp[50];
