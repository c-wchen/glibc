...
static void spring_forward_gap(void)
{
...
static void mktime_test1(time_t now)
{
...
static void mktime_test(time_t now)
{
    mktime_test1(now);
...
static void bigtime_test(int j)
{
    struct tm tm;
    time_t now;
