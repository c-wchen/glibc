...
static inline int64_t __attribute((always_inline))
...
void __tzfile_default(const char *std, const char *dst,
...

void __tzfile_compute(__time64_t timer, int use_localtime,
