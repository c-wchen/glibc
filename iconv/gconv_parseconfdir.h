...
static bool read_conf_file(const char *filename, const char *directory, size_t dir_len)
{
...
static __always_inline bool gconv_parseconfdir(const char *prefix, const char *dir, size_t dir_len)
{
