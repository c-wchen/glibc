...
static int alias_compare(const void *p1, const void *p2)
{
...
static void new_alias(const char *fromname, size_t fromlen, const char *toname,
                      size_t tolen)
{
    struct alias *newp;
    void **inserted;
...
static void append_alias(const void *nodep, VISIT value, int level)
{
...
static void new_module(const char *fromname, size_t fromlen, const char *toname,
...
/* Add new module.  */
static void add_module(char *rp, const char *directory,
...
static void append_module(const void *nodep, VISIT value, int level)
{
    struct module *mo;
...
static int name_compare(const void *p1, const void *p2)
{
...
static struct name *new_name(const char *str, struct Strent *strent)
{
...
static int name_to_module_idx(const char *name, int add)
{
    struct name **res;
...
static uint32_t next_prime(uint32_t seed)
{
