...
static int derivation_lookup(const char *fromset, const char *toset,
...
static void add_derivation(const char *fromset, const char *toset,
                           struct __gconv_step *handle, size_t nsteps)
{
...
static void free_derivation(void *p)
{
...
static int gen_steps(struct derivation_step *best, const char *toset,
...
#ifndef STATIC_GCONV
static int increment_counter(struct __gconv_step *steps, size_t nsteps)
{
...
static int find_derivation(const char *toset, const char *toset_expand,
...
int __gconv_find_transform(const char *toset, const char *fromset,
                           struct __gconv_step **handle, size_t *nsteps,
                           int flags)
{
...
int __gconv_close_transform(struct __gconv_step *steps, size_t nsteps)
{
    int result = __GCONV_OK;
    size_t cnt;
...
static void free_modules_db(struct gconv_module *node)
{
    if (node->left != NULL) {
