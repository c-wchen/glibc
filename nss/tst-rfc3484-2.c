...
void
attribute_hidden __check_pf(bool *p1, bool *p2, struct in6addrinfo **in6ai, size_t *in6ailen)
{
    *p1 = *p2 = true;
    *in6ai = NULL;
    *in6ailen = 0;
...
void
attribute_hidden __free_in6ai(struct in6addrinfo *ai)
{
}
...
int
attribute_hidden __idna_to_ascii_lz(const char *input, char **output, int flags)
{
    return 0;
}

int
attribute_hidden __idna_to_unicode_lzlz(const char *input, char **output, int flags)
{
    *output = NULL;
    return 0;
}
...
void
attribute_hidden _res_hconf_init(void)
{
}
