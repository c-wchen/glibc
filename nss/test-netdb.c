...
static void output_servent(const char *call, struct servent *sptr)
{
    char **pptr;
...
static void output_hostent(const char *call, struct hostent *hptr)
{
    char **pptr;
...
static void output_netent(const char *call, struct netent *nptr)
{
    char **pptr;
...
static void output_protoent(const char *call, struct protoent *prptr)
{
    char **pptr;
