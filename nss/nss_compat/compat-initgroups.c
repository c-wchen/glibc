...
static void internal_endgrent_noerror(ent_t *ent)
{
...
static void add_group(long int *start, long int *size, gid_t **groupsp, long int limit,
                      gid_t gid)
{
...
static int check_and_add_group(const char *user, gid_t group, long int *start,
