...
static void write_hosts(int count)
{
...
static char *expected_ghbn(const struct test_params *params)
{
...
static char *expected_gai(const struct test_params *params)
{
    bool do_ipv4 = false;
    bool do_ipv6 = false;
...
static void run_gbhn_gai(struct test_params *params)
{
