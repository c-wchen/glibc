...
int
attribute_compat_text_section __sigismember_compat(const __sigset_t *set, int sig)
{
...
int
attribute_compat_text_section __sigaddset_compat(__sigset_t *set, int sig)
{
    __sigaddset(set, sig);
    return 0;
}
...
int
attribute_compat_text_section __sigdelset_compat(__sigset_t *set, int sig)
{
    __sigdelset(set, sig);
    return 0;
}
