...
static void check_addrs_align(const struct obj_addrs *addrs)
{
...
static void check_addrs_same(const struct obj_addrs *addrs1,
...
static void check_vals_before(const struct obj_values *vals)
{
...
static void check_vals_after(const struct obj_values *vals, int base_val)
{
...
static void check_one_thread(const struct one_thread_data *data, int base_val)
{
