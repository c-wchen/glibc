...
static void update_hwcaps_counts(struct hwcaps_counts *counts, const char *hwcaps,
...
static void copy_hwcaps(struct copy_hwcaps *target, const char *hwcaps,
                        uint32_t bitmask, const char *mask)
{
    struct dl_hwcaps_split_masked sp;
    _dl_hwcaps_split_masked_init(&sp, hwcaps, bitmask, mask);
...
static void compute_priorities(size_t total_count, const char *prepend,
                               uint32_t bitmask, const char *mask)
{
...
static void sort_priorities_by_name(void)
{
...
const struct r_strlenpair *_dl_important_hwcaps(const char *glibc_hwcaps_prepend,
