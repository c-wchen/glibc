...
const char *_dl_audit_objsearch(const char *name, struct link_map *l, unsigned int code)
{
...
void _dl_audit_symbind_alt(struct link_map *l, const ElfW(Sym) *ref, void **value,
                           lookup_t result)
{
