...
static int match_symbol(const char *name, Lmid_t ns, ElfW(Word) hash, const char *string,
...
int _dl_check_all_versions(struct link_map *map, int verbose, int trace_mode)
{
    struct link_map *l;
    int result = 0;
