...
static void glibc_hwcaps_priorities_free(void)
{
...
static int glibc_hwcaps_compare(uint32_t left_index, struct dl_hwcaps_priority *right)
{
...
static void glibc_hwcaps_priorities_init(void)
{
...
static uint32_t glibc_hwcaps_priority(uint32_t index)
{
...
static inline bool _dl_cache_verify_ptr(uint32_t ptr, size_t string_table_size)
{
...
/* Compute the address of the element INDEX of the array at LIBS.
   ...
   of *LIBS.  */
static inline const struct file_entry *_dl_cache_file_entry(const struct file_entry *libs, size_t entry_size,
        size_t index)
{
...
static const char *search_cache(const char *string_table, uint32_t string_table_size,
...
char *_dl_load_cache_lookup(const char *name)
{
