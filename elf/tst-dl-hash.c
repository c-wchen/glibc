...
static int do_fill_test(size_t len, int fill, const char *name, hash_f testf,
                        hash_f expecf)
{
    uint32_t expec, res;
    char buf[len + 1];
...
static int do_fill_tests(size_t len, int fill)
{
...
static int do_rand_test(size_t len, const char *name, hash_f testf, hash_f expecf)
{
    uint32_t expec, res;
    size_t i;
    char buf[len + 1];
...
static int do_rand_tests(size_t len)
{
