...
static void target_process(void *arg)
{
    pause();
}

static void pldd_process(void *arg)
{
...
static bool in_str_list(const char *libname, const char *const strlist[])
{
