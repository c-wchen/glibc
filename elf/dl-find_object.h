...
/* Create a copy of *SOURCE in *COPY using relaxed MO loads and
   stores.  */
static inline void _dl_find_object_internal_copy(const struct dl_find_object_internal *source,
...
static inline void _dl_find_object_to_external(struct dl_find_object_internal *internal,
