...
void __rtld_malloc_init_stubs(void)
{
...
bool __rtld_malloc_is_complete(void)
{
...
static void *lookup_malloc_symbol(struct link_map *main_map, const char *name,
...
void __rtld_malloc_init_real(struct link_map *main_map)
{
