...
inline static int hash_tlsdesc(void *p)
{
...
inline static int eq_tlsdesc(void *p, void *q)
{
...
inline static size_t map_generation(struct link_map *map)
{
...
/* Returns the data pointer for a given map and tls offset that is used
   ...
   allocation failure.  */
void *_dl_make_tlsdesc_dynamic(struct link_map *map, size_t ti_offset)
{
    struct hashtab *ht;
    void **entry;
