...
static int match_pid(pid_t pid, const char *which)
{
...
/* Check whether a file name is on the colon-separated list of file
   names.  */
static unsigned int match_file(const char *list, const char *name, size_t name_len,
                               unsigned int mask)
{
    if (list[0] == '\0') {
        return 0;
...
uintptr_t la_symbind(Elf_Sym *sym, unsigned int ndx, uintptr_t *refcook,
...
static void print_enter(uintptr_t *refcook, uintptr_t *defcook, const char *symname,
...
#ifdef __i386__
Elf32_Addr la_i86_gnu_pltenter(Elf32_Sym *sym __attribute__((unused)),
...
Elf64_Addr la_x86_64_gnu_pltenter(Elf64_Sym *sym __attribute__((unused)),
                                  unsigned int ndx __attribute__((unused)),
                                  uintptr_t *refcook, uintptr_t *defcook,
...
Elf32_Addr la_sparc32_gnu_pltenter(Elf32_Sym *sym __attribute__((unused)),
                                   unsigned int ndx __attribute__((unused)),
                                   uintptr_t *refcook, uintptr_t *defcook,
...
#elif defined __sparc__ && defined __arch64__
Elf64_Addr la_sparc64_gnu_pltenter(Elf64_Sym *sym __attribute__((unused)),
                                   unsigned int ndx __attribute__((unused)),
                                   uintptr_t *refcook, uintptr_t *defcook,
...
static void print_exit(uintptr_t *refcook, uintptr_t *defcook, const char *symname,
...
#ifdef __i386__
unsigned int la_i86_gnu_pltexit(Elf32_Sym *sym, unsigned int ndx, uintptr_t *refcook,
...
#elif defined __sparc__ && !defined __arch64__
unsigned int la_sparc32_gnu_pltexit(Elf32_Sym *sym, unsigned int ndx, uintptr_t *refcook,
...
#elif defined __sparc__ && defined __arch64__
unsigned int la_sparc64_gnu_pltexit(Elf64_Sym *sym, unsigned int ndx, uintptr_t *refcook,
