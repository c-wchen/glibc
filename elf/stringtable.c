...
static void stringtable_init(struct stringtable *table)
{
    table->count = 0;
...
static uint32_t fnv1a(const char *string, size_t length)
{
...
static void stringtable_rehash(struct stringtable *table)
{
...
/* Sort reversed strings in reverse lexicographic order.  This is used
   for tail merging.  */
static int finalize_compare(const void *l, const void *r)
{
