...
static void _dl_sort_maps_original(struct link_map **maps, unsigned int nmaps,
...
static void dfs_traversal(struct link_map ***rpo, struct link_map *map,
                          bool *do_reldeps)
{
...
static void _dl_sort_maps_dfs(struct link_map **maps, unsigned int nmaps,
                              bool force_first, bool for_fini)
{
