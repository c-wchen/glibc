...
static void test_compressed_qname(void)
{
...
static void test_two_questions(void)
{
    static const unsigned char packet[] = {
        0x11, 0x12, 0x13, 0x14,
...
static void test_truncated_one_rr(size_t length)
{
...
static void test_truncated_no_rr(size_t length)
{
    unsigned char *end = (unsigned char *) ntf.buffer - ntf.length;
    unsigned char *start = end - length;
...
static void test_truncated_before_rr(size_t length)
{
    unsigned char *end = (unsigned char *) ntf.buffer - ntf.length;
    unsigned char *start = end - length;
