...
static void send_ptr(struct resolv_response_builder *b,
...
static void handle_code(const struct resolv_response_context *ctx,
...
static void check_reverse(int code, const char *expected)
{
