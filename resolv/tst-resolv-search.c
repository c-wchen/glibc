...
static void format_expected_1(FILE *out, int family, enum output_format format, int index)
{
    for (int i = 0; i < items[index].response; ++i) {
        char address[200];
        switch (family) {
...
static char *format_expected(const char *fqdn, int family, enum output_format format)
{
...
static void do_get(const char *name, const char *fqdn, int family)
{
...
static void do_gai(const char *name, const char *fqdn, int family)
{
...
static void do_both(const char *name, const char *fqdn)
{
...
static void do_test_all(bool unconnectable_server)
{
