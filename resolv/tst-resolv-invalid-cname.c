...
static const char *test_mode_to_string(enum test_mode mode)
{
    switch (mode) {
        case byname:
            return "byname";
...
static void append_names(FILE *out, const char *qname, int bits, int count,
                         enum test_mode mode)
{
...
static void append_addresses(FILE *out, int af, int bits, int count, enum test_mode mode)
{
...
static void check_forward(int af, int bits, int count, enum test_mode mode)
{
...
static void check_reverse(int af, int bits, int count)
{
