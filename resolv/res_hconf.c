...
static const char *arg_trimdomain_list(const char *fname, int line_num, const char *args)
{
    const char *start;
    size_t len;
...
static const char *arg_bool(const char *fname, int line_num, const char *args, unsigned flag)
{
...
static void parse_line(const char *fname, int line_num, const char *str)
{
    const char *start;
...
/* If HOSTNAME has a postfix matching any of the trimdomains, trim away
   ...
   was unintentional.  */
void _res_hconf_trim_domain(char *hostname)
{
