...
static void parse_qname(struct parsed_qname *parsed, const char *qname)
{
    int reorder0;
    int reorder1;
    int rcode;
...
static void build_response(const struct resolv_response_context *ctx,
...
static void test_qname(const char *qname, int rcode)
{
