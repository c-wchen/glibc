...
static char *make_qname(bool do_search, int cnames, int addresses)
{
    return xasprintf("a%d-c%d%s",
                     addresses, cnames, do_search ? "" : ".example.net");
}

static void check_cnames_failure(int af, bool do_search, int cnames, int addresses)
{
...
static void check(int af, bool do_search, int cnames, int addresses)
{
    char *qname = make_qname(do_search, cnames, addresses);
