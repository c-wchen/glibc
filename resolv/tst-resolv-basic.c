...
static void check_h(const char *name, int family, const char *expected)
{
    if (family == AF_INET) {
...
static void check_ai_hints(const char *name, const char *service,
...
static void check_ai(const char *name, const char *service,
...
static void test_bug_21295(void)
{
...
static void test_nodata_nxdomain(void)
{
