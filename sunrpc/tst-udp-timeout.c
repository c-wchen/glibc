...
static bool_t xdr_test_query(XDR *xdrs, void *data, ...)
{
...
static bool_t xdr_test_response(XDR *xdrs, void *data, ...)
{
...
static struct test_response test_call(CLIENT *clnt, int proc, struct test_query query,
...
static void test_call_timeout(CLIENT *clnt, int proc, struct test_query query,
                              struct timeval timeout)
{
    struct test_response response;
...
static void test_call_flush(CLIENT *clnt)
{
