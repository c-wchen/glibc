...
void
attribute_compat_text_section _IO_old_file_init_internal(struct _IO_FILE_plus *fp)
{
...
void
attribute_compat_text_section _IO_old_file_init(struct _IO_FILE_plus *fp)
{
...
int
attribute_compat_text_section _IO_old_file_close_it(FILE *fp)
{
...
void
attribute_compat_text_section _IO_old_file_finish(FILE *fp, int dummy)
{
    if (_IO_file_is_open(fp)) {
        _IO_old_do_flush(fp);
...
FILE *
attribute_compat_text_section _IO_old_file_fopen(FILE *fp, const char *filename, const char *mode)
{
    int oflags = 0, omode;
...
FILE *
attribute_compat_text_section _IO_old_file_attach(FILE *fp, int fd)
{
    if (_IO_file_is_open(fp)) {
        return NULL;
    }
...
FILE *
attribute_compat_text_section _IO_old_file_setbuf(FILE *fp, char *p, ssize_t len)
{
...
int
attribute_compat_text_section _IO_old_do_write(FILE *fp, const char *data, size_t to_do)
{
...
static int
attribute_compat_text_section old_do_write(FILE *fp, const char *data, size_t to_do)
{
    size_t count;
...
int
attribute_compat_text_section _IO_old_file_underflow(FILE *fp)
{
    ssize_t count;
...
int
attribute_compat_text_section _IO_old_file_overflow(FILE *f, int ch)
{
...
int
attribute_compat_text_section _IO_old_file_sync(FILE *fp)
{
    ssize_t delta;
    int retval = 0;
...
off64_t
attribute_compat_text_section _IO_old_file_seekoff(FILE *fp, off64_t offset, int dir, int mode)
{
    off_t result;
...
ssize_t
attribute_compat_text_section _IO_old_file_write(FILE *f, const void *data, ssize_t n)
{
    ssize_t to_do = n;
    while (to_do > 0) {
...
size_t
attribute_compat_text_section _IO_old_file_xsputn(FILE *f, const void *data, size_t n)
{
