...
static void unlock(void *not_used)
{
...
void _IO_proc_file_chain_lock(void)
{
    _IO_lock_lock(proc_file_chain_lock);
}

void _IO_proc_file_chain_unlock(void)
{
    _IO_lock_unlock(proc_file_chain_lock);
}

void _IO_proc_file_chain_resetlock(void)
{
...
static int spawn_process(posix_spawn_file_actions_t *fa, FILE *fp, const char *command,
...
FILE *_IO_new_proc_open(FILE *fp, const char *command, const char *mode)
{
    int read_or_write;
...
FILE *_IO_new_popen(const char *command, const char *mode)
{
    struct locked_FILE {
