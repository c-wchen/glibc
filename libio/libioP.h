...
static inline bool _IO_legacy_file(FILE *fp)
{
...
static inline void IO_set_accept_foreign_vtables(void (*flag)(void))
{
    PTR_MANGLE(flag);
...
static __always_inline void _IO_free_backup_buf(FILE *fp, char *ptr)
{
