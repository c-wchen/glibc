...
FILE *
attribute_compat_text_section _IO_old_proc_open(FILE *fp, const char *command, const char *mode)
{
...
FILE *
attribute_compat_text_section _IO_old_popen(const char *command, const char *mode)
{
    struct locked_FILE {
...
int
attribute_compat_text_section _IO_old_proc_close(FILE *fp)
{
