...
void __printf_buffer_snprintf_init(struct __printf_buffer_snprintf *buf,
...
int __printf_buffer_snprintf_done(struct __printf_buffer_snprintf *buf)
{
...
int __vsnprintf_internal(char *string, size_t maxlen, const char *format,
...
int ___vsnprintf(char *string, size_t maxlen, const char *format, va_list args)
{
