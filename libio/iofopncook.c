...
ssize_t _IO_cookie_read(FILE *fp, void *buf, ssize_t size)
{
...
ssize_t _IO_cookie_write(FILE *fp, const void *buf, ssize_t size)
{
    struct _IO_cookie_file *cfile = (struct _IO_cookie_file *) fp;
...
off64_t _IO_cookie_seek(FILE *fp, off64_t offset, int dir)
{
    struct _IO_cookie_file *cfile = (struct _IO_cookie_file *) fp;
...
off64_t _IO_cookie_seekoff(FILE *fp, off64_t offset, int dir, int mode)
{
...
/* Copy the callbacks from SOURCE to *TARGET, with pointer
   mangling.  */
static void set_callbacks(cookie_io_functions_t *target,
...
void _IO_cookie_init(struct _IO_cookie_file *cfile, int read_write,
...
off64_t
attribute_compat_text_section _IO_old_cookie_seek(FILE *fp, off64_t offset, int dir)
{
    struct _IO_cookie_file *cfile = (struct _IO_cookie_file *) fp;
...
FILE *
attribute_compat_text_section _IO_old_fopencookie(void *cookie, const char *mode,
        cookie_io_functions_t io_functions)
{
    FILE *ret;
