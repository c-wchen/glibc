...
#if defined __USE_EXTERN_INLINES && defined _LIBC
_EXTERN_INLINE void __spin_lock_init(__spin_lock_t *__lock)
{
...
#if defined __USE_EXTERN_INLINES && defined _LIBC
_EXTERN_INLINE void __spin_lock(__spin_lock_t *__lock)
{
    __lll_lock(__lock, 0);
}
#endif
...
#if defined __USE_EXTERN_INLINES && defined _LIBC
_EXTERN_INLINE void __mutex_lock(void *__lock)
{
...
#if defined __USE_EXTERN_INLINES && defined _LIBC
_EXTERN_INLINE void __mutex_unlock(void *__lock)
{
...
#if defined __USE_EXTERN_INLINES && defined _LIBC
_EXTERN_INLINE int __mutex_trylock(void *__lock)
{
